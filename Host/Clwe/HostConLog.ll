...
@OLog_Proc__desc = external global [4 x i32]
@OLog_FlushBuf = external global void ()*
@OLog_StringProc__desc = external global [4 x i32]
@OLog_String = external global void ([0 x i16]*, i32)*
@OLog_SStringProc__desc = external global [4 x i32]
@OLog_SString = external global void ([0 x i8]*, i32)*
@OLog_USStringProc__desc = external global [4 x i32]
@OLog_USString = external global void ([0 x i8]*)*
@OLog_Ln = external global void ()*
@OLog_CharProc__desc = external global [4 x i32]
@OLog_IntProc__desc = external global [4 x i32]
@OLog_RealProc__desc = external global [4 x i32]
@OLog_BoolProc__desc = external global [4 x i32]
@OLog_SetProc__desc = external global [4 x i32]
@OLog_IntFormProc__desc = external global [4 x i32]
@OLog_RealFormProc__desc = external global [4 x i32]
@OLog_AdrProc__desc = external global [4 x i32]
