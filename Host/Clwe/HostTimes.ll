...
%SYSTEM_MODDESC = type { %SYSTEM_MODDESC*, i32, i32, [6 x i16], [6 x i16], void ()*, void ()*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, [194 x i8]*, [1 x i32]*, [3 x %SYSTEM_MODDESC*]*, %SYSTEM_DIRECTORY*, [256 x i8] }
...
@HostTimes__exp = private global %SYSTEM_DIRECTORY { i32 2, [2 x %SYSTEM_OBJDESC] [%SYSTEM_OBJDESC { i32 -1682067740, i32 -881725400, i32 3602, i32 0 }, %SYSTEM_OBJDESC { i32 1628601240, i32 450668513, i32 6418, i32 ptrtoint (i32* getelementptr inbounds ([30 x i32], [30 x i32]* @HostTimes_Hook__redesc, i32 0, i32 9) to i32) }] }
@HostTimes__desc = global %SYSTEM_MODDESC { %SYSTEM_MODDESC* null, i32 3, i32 0, [6 x i16] [i16 2020, i16 6, i16 26, i16 15, i16 55, i16 49], [6 x i16] zeroinitializer, void ()* @HostTimes__body, void ()* null, i32 2, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, [194 x i8]* @HostTimes__names, [1 x i32]* @HostTimes__ptrs, [3 x %SYSTEM_MODDESC*]* @HostTimes__imp, %SYSTEM_DIRECTORY* @HostTimes__exp, [256 x i8] c"HostTimes\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00" }
@HostTimes_Hook__redesc = global [30 x i32] [i32 -1, i32 ptrtoint (void (%"HostTimes_Hook^"*, i64, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i32*)* @HostTimes_Hook_ToSystemTime to i32), i32 ptrtoint (void (%"HostTimes_Hook^"*, i64, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i32*)* @HostTimes_Hook_ToLocalTime to i32), i32 ptrtoint (void (%"HostTimes_Hook^"*, i64)* @HostTimes_Hook_Sleep to i32), i32 ptrtoint (void (%"HostTimes_Hook^"*, i32*)* @HostTimes_Hook_GetUTCBias to i32), i32 ptrtoint (i64 (%"HostTimes_Hook^"*)* @HostTimes_Hook_GetTime to i32), i32 ptrtoint (void (%"HostTimes_Hook^"*, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i64*, i32*)* @HostTimes_Hook_FromSystemTime to i32), i32 ptrtoint (void (%"HostTimes_Hook^"*, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i64*, i32*)* @HostTimes_Hook_FromLocalTime to i32), i32 0, i32 4, i32 ptrtoint (%SYSTEM_MODDESC* @HostTimes__desc to i32), i32 6417, i32 ptrtoint (i32* getelementptr inbounds ([30 x i32], [30 x i32]* @Times_Hook__redesc, i32 0, i32 9) to i32), i32 ptrtoint (i32* getelementptr inbounds ([30 x i32], [30 x i32]* @HostTimes_Hook__redesc, i32 0, i32 9) to i32), i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 ptrtoint ({ i32, [0 x %SYSTEM_OBJDESC] }* @HostTimes_Hook__redesc__flds to i32), i32 -4]
@HostTimes_Hook__desc = private global [21 x i32] [i32 0, i32 ptrtoint (%SYSTEM_MODDESC* @HostTimes__desc to i32), i32 5123, i32 ptrtoint (i32* getelementptr inbounds ([30 x i32], [30 x i32]* @HostTimes_Hook__redesc, i32 0, i32 9) to i32), i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0]
@Times_SystemTime__recdesc = external global [23 x i32]
@Times_Hook__redesc = external global [30 x i32]
...
@Times_Hook__desc = external global [21 x i32]
...
merge:                                            ; preds = %entry
  ...
  %lda5 = load i32, i32* inttoptr (i32 sub (i32 ptrtoint (i32* getelementptr inbounds ([30 x i32], [30 x i32]* @Times_Hook__redesc, i32 0, i32 9) to i32), i32 4) to i32*)
  store i32 %lda5, i32* getelementptr inbounds ([30 x i32], [30 x i32]* @HostTimes_Hook__redesc, i32 0, i32 8)
...
if.else:                                          ; preds = %entry
  store i32 0, i32* %res
  call void @HostTimes_WS2TS(%HostApi_SYSTEMTIME* %ast, %Times_SystemTime* %st, %SYSTEM_TYPEDESC* bitcast (i32* getelementptr inbounds ([23 x i32], [23 x i32]* @Times_SystemTime__recdesc, i32 0, i32 2) to %SYSTEM_TYPEDESC*))
  br label %if.end
...
if.else:                                          ; preds = %elsif
  store i32 0, i32* %res
  call void @HostTimes_WS2TS(%HostApi_SYSTEMTIME* %alt, %Times_SystemTime* %lt, %SYSTEM_TYPEDESC* bitcast (i32* getelementptr inbounds ([23 x i32], [23 x i32]* @Times_SystemTime__recdesc, i32 0, i32 2) to %SYSTEM_TYPEDESC*))
  br label %if.end
...
entry:
  ...
  call void @HostTimes_TS2WS(%Times_SystemTime* %st, %SYSTEM_TYPEDESC* bitcast (i32* getelementptr inbounds ([23 x i32], [23 x i32]* @Times_SystemTime__recdesc, i32 0, i32 2) to %SYSTEM_TYPEDESC*), %HostApi_SYSTEMTIME* %ast)
...
entry:
  ...
  %lft = alloca %HostTimes_FTime
  %ft = alloca %HostTimes_FTime
  call void @HostTimes_TS2WS(%Times_SystemTime* %lt, %SYSTEM_TYPEDESC* bitcast (i32* getelementptr inbounds ([23 x i32], [23 x i32]* @Times_SystemTime__recdesc, i32 0, i32 2) to %SYSTEM_TYPEDESC*), %HostApi_SYSTEMTIME* %ast)
  %PCAST3 = bitcast %HostTimes_FTime* %lft to %HostApi_FILETIME*
  %SystemTimeToFileTime = call x86_stdcallcc i32 @SystemTimeToFileTime(%HostApi_SYSTEMTIME* %ast, %HostApi_FILETIME* %PCAST3)
  %ICMP = icmp eq i32 %SystemTimeToFileTime, 0
  br i1 %ICMP, label %if.then, label %elsif
...
entry:
  ...
  %GetTimeZoneInformation = call x86_stdcallcc i32 @GetTimeZoneInformation(%HostApi_TIME_ZONE_INFORMATION* @HostTimes_tZone)
  store i32 %GetTimeZoneInformation, i32* %res
  %Kernel_NewRec = call i32 @Kernel_NewRec(i32 ptrtoint (i32* getelementptr inbounds ([30 x i32], [30 x i32]* @HostTimes_Hook__redesc, i32 0, i32 9) to i32))
