...
static _CHAR OStrings_toUpper[256], OStrings_toLower[256];
...
export void OStrings_GetUtf8 (SHORTCHAR *str, INTEGER str__len, INTEGER *val, INTEGER *idx);
static void OStrings_Init (void);
export _CHAR OStrings_Lower (_CHAR ch);
export void OStrings_PutUtf8 (SHORTCHAR *str, INTEGER str__len, INTEGER val, INTEGER *idx);
...
export void OStrings_ToLower (_CHAR *in, INTEGER in__len, _CHAR *out, INTEGER out__len);
export void OStrings_ToUpper (_CHAR *in, INTEGER in__len, _CHAR *out, INTEGER out__len);
export _CHAR OStrings_Upper (_CHAR ch);
...
static struct StdSetToString__14 {
	INTEGER *len;
	struct StdSetToString__14 *lnk;
} *StdSetToString__14_s;

static void __15 (_CHAR ch, INTEGER *len, _CHAR *str, INTEGER str__len);
static void __17 (INTEGER x, INTEGER *len, _CHAR *str, INTEGER str__len);
...
{
	INTEGER len, i;
	struct StdSetToString__14 _s;
	__ENTER("OStrings.StdSetToString");
	_s.len = &len;
	_s.lnk = StdSetToString__14_s;
	StdSetToString__14_s = &_s;
	str[0] = 0;
	len = 0;
	__15((_CHAR)L'{', &len, (void*)str, str__len);
	i = 0;
	while (x != 0x0) {
		if (__IN(i, x)) {
			__17(i, &len, (void*)str, str__len);
			x &= ~__SETOF(i);
			if ((i <= 29 && __IN(i + 1, x)) && __IN(i + 2, x)) {
				...
				__17(i - 1, &len, (void*)str, str__len);
			}
			if (x != 0x0) {
				__15((_CHAR)L',', &len, (void*)str, str__len);
				__15((_CHAR)L' ', &len, (void*)str, str__len);
	...
	__15((_CHAR)L'}', &len, (void*)str, str__len);
	__15(0, &len, (void*)str, str__len);
	StdSetToString__14_s = _s.lnk;
	__EXIT;
}

static struct StdStringToSet__22 {
	INTEGER *next;
	_CHAR *ch;
	struct StdStringToSet__22 *lnk;
} *StdStringToSet__22_s;

static void __23 (_CHAR *s, INTEGER s__len, _CHAR *ch, INTEGER *next);
static INTEGER __25 (_CHAR *s, INTEGER s__len, _CHAR *ch, INTEGER *next, INTEGER *res);
static void __27 (_CHAR *s, INTEGER s__len, _CHAR *ch, INTEGER x1, INTEGER *next, SET *x, INTEGER *res);
...
static void __27 (_CHAR *s, INTEGER s__len, _CHAR *ch, INTEGER x1, INTEGER *next, SET *x, INTEGER *res)
{
	...
	*next += 1;
	if (*ch == (_CHAR)L'.') {
		__23((void*)s, s__len, ch, next);
		if ((_CHAR)L'0' <= *ch && *ch <= (_CHAR)L'9') {
			x2 = __25((void*)s, s__len, ch, next, res);
			if (*res == 0) {
				if (x2 >= x1) {
					_for__29 = x2;
					i = x1;
...
void OStrings_StdStringToSet (_CHAR *s, INTEGER s__len, SET *x, INTEGER *res)
{
	INTEGER next, x1;
	_CHAR ch;
	struct StdStringToSet__22 _s;
	__ENTER("OStrings.StdStringToSet");
	_s.next = &next;
	_s.ch = &ch;
	_s.lnk = StdStringToSet__22_s;
	StdStringToSet__22_s = &_s;
	*x = 0x0;
	*res = 0;
	next = 0;
	__23((void*)s, s__len, &ch, &next);
	if (ch == (_CHAR)L'{') {
		...
		while (((_CHAR)L'0' <= ch && ch <= (_CHAR)L'9') && *res != 2) {
			x1 = __25((void*)s, s__len, &ch, &next, res);
			if (ch == (_CHAR)L'.') {
				__27((void*)s, s__len, &ch, x1, &next, x, res);
			} else if (*res == 0) {
				*x |= __SETOF(x1);
			}
			if (ch == (_CHAR)L',') {
	...
	StdStringToSet__22_s = _s.lnk;
	__EXIT;
}

_CHAR OStrings_Upper (_CHAR ch)
{
	__ENTER("OStrings.Upper");
	if ((INTEGER)ch < 256) {
		__EXIT;
		return OStrings_toUpper[__X((INTEGER)ch, 256)];
	} else {
		__EXIT;
		return ch;
	}
...
void OStrings_ToUpper (_CHAR *in, INTEGER in__len, _CHAR *out, INTEGER out__len)
{
	INTEGER i, max;
	__ENTER("OStrings.ToUpper");
	__DUP(in, in__len);
	i = 0;
	max = out__len - 1;
	while (in[__X(i, in__len)] != 0 && i < max) {
		if ((INTEGER)in[__X(i, in__len)] < 256) {
			out[__X(i, out__len)] = OStrings_toUpper[__X((INTEGER)in[__X(i, in__len)], 256)];
		} else {
			out[__X(i, out__len)] = in[__X(i, in__len)];
		}
		i += 1;
	}
	out[__X(i, out__len)] = 0;
	__DEL(in);
	__EXIT;
}

_CHAR OStrings_Lower (_CHAR ch)
{
	__ENTER("OStrings.Lower");
	if ((INTEGER)ch < 256) {
		__EXIT;
		return OStrings_toLower[__X((INTEGER)ch, 256)];
	} else {
		__EXIT;
		return ch;
	}
...
void OStrings_ToLower (_CHAR *in, INTEGER in__len, _CHAR *out, INTEGER out__len)
{
	INTEGER i, max;
	__ENTER("OStrings.ToLower");
	__DUP(in, in__len);
	i = 0;
	max = out__len - 1;
	while (in[__X(i, in__len)] != 0 && i < max) {
		if ((INTEGER)in[__X(i, in__len)] < 256) {
			out[__X(i, out__len)] = OStrings_toLower[__X((INTEGER)in[__X(i, in__len)], 256)];
		} else {
			out[__X(i, out__len)] = in[__X(i, in__len)];
		}
		i += 1;
...
void OStrings_PutUtf8 (SHORTCHAR *str, INTEGER str__len, INTEGER val, INTEGER *idx)
{
	__ENTER("OStrings.PutUtf8");
	__ASSERT(val >= 0, 20);
	__ASSERT(val < 65536, 21);
	if (val < 128) {
		str[__X(*idx, str__len)] = (SHORTCHAR)val;
		*idx += 1;
	} else if (val < 2048) {
		str[__X(*idx, str__len)] = (SHORTCHAR)(__ASHR(val, 6, INTEGER) + 192);
		*idx += 1;
		str[__X(*idx, str__len)] = (SHORTCHAR)(__MASK(val, -64) + 128);
		*idx += 1;
	} else {
		str[__X(*idx, str__len)] = (SHORTCHAR)(__ASHR(val, 12, INTEGER) + 224);
		*idx += 1;
		str[__X(*idx, str__len)] = (SHORTCHAR)(__MASK(__ASHR(val, 6, INTEGER), -64) + 128);
		*idx += 1;
		str[__X(*idx, str__len)] = (SHORTCHAR)(__MASK(val, -64) + 128);
		*idx += 1;
	}
...
void OStrings_GetUtf8 (SHORTCHAR *str, INTEGER str__len, INTEGER *val, INTEGER *idx)
{
	SHORTCHAR ch;
	__ENTER("OStrings.GetUtf8");
	ch = str[__X(*idx, str__len)];
	*idx += 1;
	if (ch < 128) {
		*val = (SHORTINT)ch;
	} else if (ch < 224) {
...
static void OStrings_Init (void)
{
	...
	i = 0;
	while (i <= 255) {
		OStrings_toUpper[__X(i, 256)] = (_CHAR)i;
		OStrings_toLower[__X(i, 256)] = (_CHAR)i;
		i += 1;
	}
	i = 65;
	while (i <= 90) {
		OStrings_toLower[__X(i, 256)] = (_CHAR)(i + 32);
		OStrings_toUpper[__X(i + 32, 256)] = (_CHAR)i;
		i += 1;
	}
	i = 192;
	while (i <= 214) {
...
static ADDRESS OStrings__exp[] = {
	...
	0x28b57df0, (ADDRESS)OStrings_GetUtf8, 169<<8 | 0x44, 0,
	0x9f733d16, (ADDRESS)&OStrings_IntToString, 177<<8 | 0x23, (ADDRESS)OStrings_IntToStringProc__desc,
	0x41a20324, (ADDRESS)&OStrings_IntToStringForm, 189<<8 | 0x23, (ADDRESS)OStrings_IntToStringFormProc__desc,
	...
	0x2574e362, (ADDRESS)OStrings_Lower, 205<<8 | 0x44, 0,
	0x8eab1b35, (ADDRESS)OStrings_PutUtf8, 211<<8 | 0x44, 0,
	0x83f8f47b, (ADDRESS)&OStrings_RealToString, 219<<8 | 0x23, (ADDRESS)OStrings_RealToStringProc__desc,
	0x21f88459, (ADDRESS)&OStrings_RealToStringForm, 232<<8 | 0x23, (ADDRESS)OStrings_RealToStringFormProc__desc,
	...
	0x79b3ef3d, (ADDRESS)OStrings_SetProcs, 249<<8 | 0x44, 0,
	0xc2cd1451, (ADDRESS)&OStrings_SetToString, 258<<8 | 0x23, (ADDRESS)OStrings_SetToStringProc__desc,
	0x06e6e88d, 0x06e6e88d, 75<<8 | 0x42, (ADDRESS)OStrings_SetToStringProc__desc,
	0x8e9ade0a, (ADDRESS)OStrings_StdIntToString, 270<<8 | 0x44, 0,
	0xf8fe7fd7, (ADDRESS)OStrings_StdIntToStringForm, 285<<8 | 0x44, 0,
	0xb6bd4fc0, (ADDRESS)OStrings_StdRealToString, 304<<8 | 0x44, 0,
	0xeac4cd11, (ADDRESS)OStrings_StdRealToStringForm, 320<<8 | 0x44, 0,
	0x5e1919c5, (ADDRESS)OStrings_StdSetToString, 340<<8 | 0x44, 0,
	0x3f9ce54f, (ADDRESS)OStrings_StdStringToInt, 355<<8 | 0x44, 0,
	0x1922285c, (ADDRESS)OStrings_StdStringToLInt, 370<<8 | 0x44, 0,
	0xf1efc869, (ADDRESS)OStrings_StdStringToReal, 386<<8 | 0x44, 0,
	0xe63cf934, (ADDRESS)OStrings_StdStringToSet, 402<<8 | 0x44, 0,
	0x9d265d50, (ADDRESS)&OStrings_StringToInt, 417<<8 | 0x23, (ADDRESS)OStrings_StringToIntProc__desc,
	0x0cadf4e9, 0x0cadf4e9, 91<<8 | 0x42, (ADDRESS)OStrings_StringToIntProc__desc,
	0x7ecd49ef, (ADDRESS)&OStrings_StringToLInt, 429<<8 | 0x23, (ADDRESS)OStrings_StringToLIntProc__desc,
	0x218f7e44, 0x218f7e44, 107<<8 | 0x42, (ADDRESS)OStrings_StringToLIntProc__desc,
	0x744da9d7, (ADDRESS)&OStrings_StringToReal, 442<<8 | 0x23, (ADDRESS)OStrings_StringToRealProc__desc,
	0xcd8c55a7, 0xcd8c55a7, 124<<8 | 0x42, (ADDRESS)OStrings_StringToRealProc__desc,
	0x295111f6, (ADDRESS)&OStrings_StringToSet, 455<<8 | 0x23, (ADDRESS)OStrings_StringToSetProc__desc,
	0x7a321740, 0x7a321740, 141<<8 | 0x42, (ADDRESS)OStrings_StringToSetProc__desc,
	0xfcde42a0, (ADDRESS)OStrings_ToLower, 467<<8 | 0x44, 0,
	0xfcde42a0, (ADDRESS)OStrings_ToUpper, 475<<8 | 0x44, 0,
	0x2574e362, (ADDRESS)OStrings_Upper, 483<<8 | 0x44, 0,
	0x9149d921, 0, 489<<8 | 0x41, 0,
	0x79c7d28c, 0, 500<<8 | 0x41, 0,
	0x9588c496, 0, 509<<8 | 0x41, 0,
	0x98cbe24f, 0, 522<<8 | 0x41, 0,
};
