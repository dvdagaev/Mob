...
import void OStrings_GetUtf8 (SHORTCHAR *str, INTEGER str__len, INTEGER *val, INTEGER *idx);
import _CHAR OStrings_Lower (_CHAR ch);
import void OStrings_PutUtf8 (SHORTCHAR *str, INTEGER str__len, INTEGER val, INTEGER *idx);
...
import void OStrings_ToLower (_CHAR *in, INTEGER in__len, _CHAR *out, INTEGER out__len);
import void OStrings_ToUpper (_CHAR *in, INTEGER in__len, _CHAR *out, INTEGER out__len);
import _CHAR OStrings_Upper (_CHAR ch);
