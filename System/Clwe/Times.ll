...
@Times_Hook__redesc = global [30 x i32] [i32 -1, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 4, i32 ptrtoint (%SYSTEM_MODDESC* @Times__desc to i32), i32 36109, i32 ptrtoint (i32* getelementptr inbounds ([30 x i32], [30 x i32]* @Times_Hook__redesc, i32 0, i32 9) to i32), i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 ptrtoint ({ i32, [0 x %SYSTEM_OBJDESC] }* @Times_Hook__redesc__flds to i32), i32 -4]
...
phi.merge:                                        ; preds = %phi.else, %phi.then
  ...
  %GetTime = inttoptr i32 %MINUS5 to i64 (%"Times_Hook^"*)**
...
phi.merge:                                        ; preds = %phi.else, %phi.then
  ...
  %ToSystemTime = inttoptr i32 %MINUS8 to void (%"Times_Hook^"*, i64, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i32*)**
  ...
  call void %lda9(%"Times_Hook^"* %lda4, i64 %lda5, %Times_SystemTime* %st, %SYSTEM_TYPEDESC* bitcast (i32* getelementptr inbounds ([23 x i32], [23 x i32]* @Times_SystemTime__recdesc, i32 0, i32 2) to %SYSTEM_TYPEDESC*), i32* %res)
...
phi.merge:                                        ; preds = %phi.else, %phi.then
  ...
  %ToLocalTime = inttoptr i32 %MINUS8 to void (%"Times_Hook^"*, i64, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i32*)**
  ...
  call void %lda9(%"Times_Hook^"* %lda4, i64 %lda5, %Times_SystemTime* %lt, %SYSTEM_TYPEDESC* bitcast (i32* getelementptr inbounds ([23 x i32], [23 x i32]* @Times_SystemTime__recdesc, i32 0, i32 2) to %SYSTEM_TYPEDESC*), i32* %res)
  %lda10 = load %SYSTEM_DLINK*, %SYSTEM_DLINK** @Kernel_dLink
  %next11 = getelementptr inbounds %SYSTEM_DLINK, %SYSTEM_DLINK* %lda10, i32 0, i32 0
  %lda12 = load %SYSTEM_DLINK*, %SYSTEM_DLINK** %next11
  store %SYSTEM_DLINK* %lda12, %SYSTEM_DLINK** @Kernel_dLink
...
phi.merge:                                        ; preds = %phi.else, %phi.then
  ...
  %FromSystemTime = inttoptr i32 %MINUS7 to void (%"Times_Hook^"*, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i64*, i32*)**
  ...
  call void %lda8(%"Times_Hook^"* %lda4, %Times_SystemTime* %st, %SYSTEM_TYPEDESC* bitcast (i32* getelementptr inbounds ([23 x i32], [23 x i32]* @Times_SystemTime__recdesc, i32 0, i32 2) to %SYSTEM_TYPEDESC*), i64* %t, i32* %res)
...
phi.merge:                                        ; preds = %phi.else, %phi.then
  ...
  %FromLocalTime = inttoptr i32 %MINUS7 to void (%"Times_Hook^"*, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i64*, i32*)**
  ...
  call void %lda8(%"Times_Hook^"* %lda4, %Times_SystemTime* %lt, %SYSTEM_TYPEDESC* bitcast (i32* getelementptr inbounds ([23 x i32], [23 x i32]* @Times_SystemTime__recdesc, i32 0, i32 2) to %SYSTEM_TYPEDESC*), i64* %t, i32* %res)
  %lda9 = load %SYSTEM_DLINK*, %SYSTEM_DLINK** @Kernel_dLink
  %next10 = getelementptr inbounds %SYSTEM_DLINK, %SYSTEM_DLINK* %lda9, i32 0, i32 0
  %lda11 = load %SYSTEM_DLINK*, %SYSTEM_DLINK** %next10
  store %SYSTEM_DLINK* %lda11, %SYSTEM_DLINK** @Kernel_dLink
...
phi.merge:                                        ; preds = %phi.else, %phi.then
  ...
  %GetUTCBias = inttoptr i32 %MINUS6 to void (%"Times_Hook^"*, i32*)**
...
phi.merge:                                        ; preds = %phi.else, %phi.then
  ...
  %Sleep = inttoptr i32 %MINUS7 to void (%"Times_Hook^"*, i64)**
