...
@Files_File__redesc = global [32 x i32] [i32 -1, i32 0, i32 0, i32 0, i32 0, i32 0, i32 ptrtoint (void (%"Files_File^"*, [16 x i16])* @Files_File_InitType to i32), i32 0, i32 0, i32 0, i32 0, i32 36, i32 ptrtoint (%SYSTEM_MODDESC* @Files__desc to i32), i32 54285, i32 ptrtoint (i32* getelementptr inbounds ([32 x i32], [32 x i32]* @Files_File__redesc, i32 0, i32 11) to i32), i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 ptrtoint ({ i32, [2 x %SYSTEM_OBJDESC] }* @Files_File__redesc__flds to i32), i32 -4]
@Files_File__desc = global [21 x i32] [i32 0, i32 ptrtoint (%SYSTEM_MODDESC* @Files__desc to i32), i32 48131, i32 ptrtoint (i32* getelementptr inbounds ([32 x i32], [32 x i32]* @Files_File__redesc, i32 0, i32 11) to i32), i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0]
...
@Files_Reader__redesc = global [28 x i32] [i32 -1, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 4, i32 ptrtoint (%SYSTEM_MODDESC* @Files__desc to i32), i32 69389, i32 ptrtoint (i32* getelementptr inbounds ([28 x i32], [28 x i32]* @Files_Reader__redesc, i32 0, i32 7) to i32), i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 ptrtoint ({ i32, [1 x %SYSTEM_OBJDESC] }* @Files_Reader__redesc__flds to i32), i32 -4]
...
@n_Files_InitType = private global [9 x i8] c"InitType\00"
@n_Files_SetDir = private global [7 x i8] c"SetDir\00"
@n_Files__reg = private global [5 x i8] c"_reg\00"
...
@n_Files__body = private global [6 x i8] c"_body\00"
...
entry:
  ...
  store [0 x i8]* bitcast ([5 x i8]* @n_Files__reg to [0 x i8]*), [0 x i8]** %procname
...
entry:
  ...
  store %SYSTEM_MODDESC* @Files__desc, %SYSTEM_MODDESC** %mod
  %procname = getelementptr inbounds %SYSTEM_DLINK, %SYSTEM_DLINK* %dlink, i32 0, i32 2
  store [0 x i8]* bitcast ([6 x i8]* @n_Files__body to [0 x i8]*), [0 x i8]** %procname
  store %SYSTEM_DLINK* %dlink, %SYSTEM_DLINK** @Kernel_dLink
  %lda1 = load i32, i32* getelementptr inbounds (%SYSTEM_MODDESC, %SYSTEM_MODDESC* @Files__desc, i32 0, i32 1)
...
entry:
  ...
  store %SYSTEM_MODDESC* @Files__desc, %SYSTEM_MODDESC** %mod
  %procname = getelementptr inbounds %SYSTEM_DLINK, %SYSTEM_DLINK* %dlink, i32 0, i32 2
  store [0 x i8]* bitcast ([9 x i8]* @n_Files_InitType to [0 x i8]*), [0 x i8]** %procname
  store %SYSTEM_DLINK* %dlink, %SYSTEM_DLINK** @Kernel_dLink
...
entry:
  ...
  store %SYSTEM_MODDESC* @Files__desc, %SYSTEM_MODDESC** %mod
  %procname = getelementptr inbounds %SYSTEM_DLINK, %SYSTEM_DLINK* %dlink, i32 0, i32 2
  store [0 x i8]* bitcast ([7 x i8]* @n_Files_SetDir to [0 x i8]*), [0 x i8]** %procname
  store %SYSTEM_DLINK* %dlink, %SYSTEM_DLINK** @Kernel_dLink
