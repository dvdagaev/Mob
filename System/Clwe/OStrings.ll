...
%SYSTEM_MODDESC = type { %SYSTEM_MODDESC*, i32, i32, [6 x i16], [6 x i16], void ()*, void ()*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, [912 x i8]*, [1 x i32]*, [2 x %SYSTEM_MODDESC*]*, %SYSTEM_DIRECTORY*, [256 x i8] }
...
@OStrings__exp = private global %SYSTEM_DIRECTORY { i32 39, [39 x %SYSTEM_OBJDESC] [%SYSTEM_OBJDESC { i32 1861729543, i32 0, i32 1345, i32 0 }, %SYSTEM_OBJDESC { i32 682982896, i32 ptrtoint (void ([0 x i8]*, i32, i32*, i32*)* @OStrings_GetUtf8 to i32), i32 4420, i32 0 }, %SYSTEM_OBJDESC { i32 -1619837674, i32 ptrtoint (void (i64, [0 x i16]*, i32)** @OStrings_IntToString to i32), i32 7715, i32 ptrtoint ([21 x i32]* @OStrings_IntToStringProc__desc to i32) }, %SYSTEM_OBJDESC { i32 1101136676, i32 ptrtoint (void (i64, i32, i32, i16, i1, [0 x i16]*, i32)** @OStrings_IntToStringForm to i32), i32 10787, i32 ptrtoint ([21 x i32]* @OStrings_IntToStringFormProc__desc to i32) }, %SYSTEM_OBJDESC { i32 -1882238994, i32 -1882238994, i32 14914, i32 ptrtoint ([21 x i32]* @OStrings_IntToStringFormProc__desc to i32) }, %SYSTEM_OBJDESC { i32 1543908299, i32 1543908299, i32 20034, i32 ptrtoint ([21 x i32]* @OStrings_IntToStringProc__desc to i32) }, %SYSTEM_OBJDESC { i32 628417378, i32 ptrtoint (i16 (i16)* @OStrings_Lower to i32), i32 24132, i32 0 }, %SYSTEM_OBJDESC { i32 -1901389003, i32 ptrtoint (void ([0 x i8]*, i32, i32, i32*)* @OStrings_PutUtf8 to i32), i32 30020, i32 0 }, %SYSTEM_OBJDESC { i32 -2080836485, i32 ptrtoint (void (double, [0 x i16]*, i32)** @OStrings_RealToString to i32), i32 32035, i32 ptrtoint ([21 x i32]* @OStrings_RealToStringProc__desc to i32) }, %SYSTEM_OBJDESC { i32 569934937, i32 ptrtoint (void (double, i32, i32, i32, i16, [0 x i16]*, i32)** @OStrings_RealToStringForm to i32), i32 35363, i32 ptrtoint ([21 x i32]* @OStrings_RealToStringFormProc__desc to i32) }, %SYSTEM_OBJDESC { i32 -812036757, i32 -812036757, i32 39746, i32 ptrtoint ([21 x i32]* @OStrings_RealToStringFormProc__desc to i32) }, %SYSTEM_OBJDESC { i32 1309360307, i32 1309360307, i32 45122, i32 ptrtoint ([21 x i32]* @OStrings_RealToStringProc__desc to i32) }, %SYSTEM_OBJDESC { i32 2041835325, i32 ptrtoint (void (void (i64, [0 x i16]*, i32)*, void (i64, i32, i32, i16, i1, [0 x i16]*, i32)*, void ([0 x i16]*, i32, i32*, i32*)*, void ([0 x i16]*, i32, i64*, i32*)*, void (double, [0 x i16]*, i32)*, void (double, i32, i32, i32, i16, [0 x i16]*, i32)*, void ([0 x i16]*, i32, double*, i32*)*, void (i32, [0 x i16]*, i32)*, void ([0 x i16]*, i32, i32*, i32*)*)* @OStrings_SetProcs to i32), i32 51268, i32 0 }, %SYSTEM_OBJDESC { i32 -1026747311, i32 ptrtoint (void (i32, [0 x i16]*, i32)** @OStrings_SetToString to i32), i32 53539, i32 ptrtoint ([21 x i32]* @OStrings_SetToStringProc__desc to i32) }, %SYSTEM_OBJDESC { i32 115796109, i32 115796109, i32 56642, i32 ptrtoint ([21 x i32]* @OStrings_SetToStringProc__desc to i32) }, %SYSTEM_OBJDESC { i32 -1902453238, i32 ptrtoint (void (i64, [0 x i16]*, i32)* @OStrings_StdIntToString to i32), i32 60740, i32 0 }, %SYSTEM_OBJDESC { i32 -117538857, i32 ptrtoint (void (i64, i32, i32, i16, i1, [0 x i16]*, i32)* @OStrings_StdIntToStringForm to i32), i32 64580, i32 0 }, %SYSTEM_OBJDESC { i32 -1229107264, i32 ptrtoint (void (double, [0 x i16]*, i32)* @OStrings_StdRealToString to i32), i32 69444, i32 0 }, %SYSTEM_OBJDESC { i32 -356201199, i32 ptrtoint (void (double, i32, i32, i32, i16, [0 x i16]*, i32)* @OStrings_StdRealToStringForm to i32), i32 73540, i32 0 }, %SYSTEM_OBJDESC { i32 1578703301, i32 ptrtoint (void (i32, [0 x i16]*, i32)* @OStrings_StdSetToString to i32), i32 78660, i32 0 }, %SYSTEM_OBJDESC { i32 1067246927, i32 ptrtoint (void ([0 x i16]*, i32, i32*, i32*)* @OStrings_StdStringToInt to i32), i32 82500, i32 0 }, %SYSTEM_OBJDESC { i32 421668956, i32 ptrtoint (void ([0 x i16]*, i32, i64*, i32*)* @OStrings_StdStringToLInt to i32), i32 86340, i32 0 }, %SYSTEM_OBJDESC { i32 -235943831, i32 ptrtoint (void ([0 x i16]*, i32, double*, i32*)* @OStrings_StdStringToReal to i32), i32 90436, i32 0 }, %SYSTEM_OBJDESC { i32 -432211660, i32 ptrtoint (void ([0 x i16]*, i32, i32*, i32*)* @OStrings_StdStringToSet to i32), i32 94532, i32 0 }, %SYSTEM_OBJDESC { i32 -1658430128, i32 ptrtoint (void ([0 x i16]*, i32, i32*, i32*)** @OStrings_StringToInt to i32), i32 98339, i32 ptrtoint ([21 x i32]* @OStrings_StringToIntProc__desc to i32) }, %SYSTEM_OBJDESC { i32 212727017, i32 212727017, i32 101442, i32 ptrtoint ([21 x i32]* @OStrings_StringToIntProc__desc to i32) }, %SYSTEM_OBJDESC { i32 2127383023, i32 ptrtoint (void ([0 x i16]*, i32, i64*, i32*)** @OStrings_StringToLInt to i32), i32 105507, i32 ptrtoint ([21 x i32]* @OStrings_StringToLIntProc__desc to i32) }, %SYSTEM_OBJDESC { i32 563052100, i32 563052100, i32 108866, i32 ptrtoint ([21 x i32]* @OStrings_StringToLIntProc__desc to i32) }, %SYSTEM_OBJDESC { i32 1951246807, i32 ptrtoint (void ([0 x i16]*, i32, double*, i32*)** @OStrings_StringToReal to i32), i32 113187, i32 ptrtoint ([21 x i32]* @OStrings_StringToRealProc__desc to i32) }, %SYSTEM_OBJDESC { i32 -846441049, i32 -846441049, i32 116546, i32 ptrtoint ([21 x i32]* @OStrings_StringToRealProc__desc to i32) }, %SYSTEM_OBJDESC { i32 693178870, i32 ptrtoint (void ([0 x i16]*, i32, i32*, i32*)** @OStrings_StringToSet to i32), i32 120867, i32 ptrtoint ([21 x i32]* @OStrings_StringToSetProc__desc to i32) }, %SYSTEM_OBJDESC { i32 2050103104, i32 2050103104, i32 123970, i32 ptrtoint ([21 x i32]* @OStrings_StringToSetProc__desc to i32) }, %SYSTEM_OBJDESC { i32 -52542816, i32 ptrtoint (void ([0 x i16]*, i32, [0 x i16]*, i32)* @OStrings_ToLower to i32), i32 128068, i32 0 }, %SYSTEM_OBJDESC { i32 -52542816, i32 ptrtoint (void ([0 x i16]*, i32, [0 x i16]*, i32)* @OStrings_ToUpper to i32), i32 130116, i32 0 }, %SYSTEM_OBJDESC { i32 628417378, i32 ptrtoint (i16 (i16)* @OStrings_Upper to i32), i32 132164, i32 0 }, %SYSTEM_OBJDESC { i32 -1857431263, i32 0, i32 135745, i32 0 }, %SYSTEM_OBJDESC { i32 2043138700, i32 0, i32 138561, i32 0 }, %SYSTEM_OBJDESC { i32 -1786198890, i32 0, i32 140865, i32 0 }, %SYSTEM_OBJDESC { i32 -1731468721, i32 0, i32 144193, i32 0 }] }
@OStrings__desc = global %SYSTEM_MODDESC { %SYSTEM_MODDESC* null, i32 3, i32 0, [6 x i16] [i16 2020, i16 6, i16 26, i16 15, i16 55, i16 48], [6 x i16] zeroinitializer, void ()* @OStrings__body, void ()* null, i32 1, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, [912 x i8]* @OStrings__names, [1 x i32]* @OStrings__ptrs, [2 x %SYSTEM_MODDESC*]* @OStrings__imp, %SYSTEM_DIRECTORY* @OStrings__exp, [256 x i8] c"OStrings\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00" }
@OStrings_IntToStringProc__desc = global [21 x i32] [i32 0, i32 ptrtoint (%SYSTEM_MODDESC* @OStrings__desc to i32), i32 19968, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0]
@OStrings_IntToString = global void (i64, [0 x i16]*, i32)* null
@OStrings_IntToStringFormProc__desc = global [21 x i32] [i32 0, i32 ptrtoint (%SYSTEM_MODDESC* @OStrings__desc to i32), i32 14848, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0]
@OStrings_IntToStringForm = global void (i64, i32, i32, i16, i1, [0 x i16]*, i32)* null
@OStrings_StringToIntProc__desc = global [21 x i32] [i32 0, i32 ptrtoint (%SYSTEM_MODDESC* @OStrings__desc to i32), i32 101376, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0]
@OStrings_StringToInt = global void ([0 x i16]*, i32, i32*, i32*)* null
@OStrings_StringToLIntProc__desc = global [21 x i32] [i32 0, i32 ptrtoint (%SYSTEM_MODDESC* @OStrings__desc to i32), i32 108800, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0]
@OStrings_StringToLInt = global void ([0 x i16]*, i32, i64*, i32*)* null
@OStrings_RealToStringProc__desc = global [21 x i32] [i32 0, i32 ptrtoint (%SYSTEM_MODDESC* @OStrings__desc to i32), i32 45056, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0]
@OStrings_RealToString = global void (double, [0 x i16]*, i32)* null
@OStrings_RealToStringFormProc__desc = global [21 x i32] [i32 0, i32 ptrtoint (%SYSTEM_MODDESC* @OStrings__desc to i32), i32 39680, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0]
@OStrings_RealToStringForm = global void (double, i32, i32, i32, i16, [0 x i16]*, i32)* null
@OStrings_StringToRealProc__desc = global [21 x i32] [i32 0, i32 ptrtoint (%SYSTEM_MODDESC* @OStrings__desc to i32), i32 116480, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0]
@OStrings_StringToReal = global void ([0 x i16]*, i32, double*, i32*)* null
@OStrings_SetToStringProc__desc = global [21 x i32] [i32 0, i32 ptrtoint (%SYSTEM_MODDESC* @OStrings__desc to i32), i32 56576, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0]
@OStrings_SetToString = global void (i32, [0 x i16]*, i32)* null
@OStrings_StringToSetProc__desc = global [21 x i32] [i32 0, i32 ptrtoint (%SYSTEM_MODDESC* @OStrings__desc to i32), i32 123904, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0]
...
while.cond63:                                     ; preds = %while.body64, %while.end48
  %lda66 = load i32, i32* %j
  %ICMP67 = icmp sle i32 %lda66, 9
  br i1 %ICMP67, label %while.body64, label %while.end65

while.body64:                                     ; preds = %while.cond63
  %lda68 = load i32, i32* %j
  %INDX69 = getelementptr inbounds [17 x i16], [17 x i16]* @OStrings_cDigits, i32 0, i32 %lda68
  %lda70 = load i32, i32* %j
  %PLUS71 = add i32 %lda70, 48
  %conv72 = trunc i32 %PLUS71 to i16
  store i16 %conv72, i16* %INDX69
  %lda73 = load i32, i32* %j
  %PLUS74 = add i32 %lda73, 1
  store i32 %PLUS74, i32* %j
  br label %while.cond63
...
while.cond75:                                     ; preds = %while.body76, %while.end65
  %lda78 = load i32, i32* %j
  %ICMP79 = icmp sle i32 %lda78, 15
  br i1 %ICMP79, label %while.body76, label %while.end77

while.body76:                                     ; preds = %while.cond75
  %lda80 = load i32, i32* %j
  %INDX81 = getelementptr inbounds [17 x i16], [17 x i16]* @OStrings_cDigits, i32 0, i32 %lda80
  %lda82 = load i32, i32* %j
  %MINUS = sub i32 %lda82, 10
  %PLUS83 = add i32 %MINUS, 65
  %conv84 = trunc i32 %PLUS83 to i16
  store i16 %conv84, i16* %INDX81
...
while.end77:                                      ; preds = %while.cond75
  ...
  %conv87 = fptosi double %Log10 to i32
  %conv88 = sitofp i32 %conv87 to double
  %FCMP = fcmp ogt double %conv88, %Log10
  br i1 %FCMP, label %phi.then, label %phi.else

phi.then:                                         ; preds = %while.end77
  %MINUS89 = sub i32 %conv87, 1
  br label %phi.merge

phi.else:                                         ; preds = %while.end77
  br label %phi.merge

phi.merge:                                        ; preds = %phi.else, %phi.then
  %INL = phi i32 [ %MINUS89, %phi.then ], [ %conv87, %phi.else ]
  %PLUS90 = add i32 %INL, 1
  store i32 %PLUS90, i32* @OStrings_maxExp
  store double 1.000000e+00, double* %eps
  store double 2.000000e+00, double* %e
  br label %while.cond91

while.cond91:                                     ; preds = %while.body92, %phi.merge
  %lda94 = load double, double* %e
  %FCMP95 = fcmp ogt double %lda94, 1.000000e+00
  br i1 %FCMP95, label %while.body92, label %while.end93

while.body92:                                     ; preds = %while.cond91
  %lda96 = load double, double* %eps
  %SLASH = fdiv double %lda96, 2.000000e+00
  store double %SLASH, double* %eps
  %lda97 = load double, double* %eps
  %PLUS98 = fadd double 1.000000e+00, %lda97
  store double %PLUS98, double* %e
  br label %while.cond91

while.end93:                                      ; preds = %while.cond91
  %lda99 = load double, double* %eps
  %TIMES = fmul double 2.000000e+00, %lda99
  store double %TIMES, double* %eps
  %lda100 = load double, double* %eps
  %Log10101 = call double @log10(double %lda100)
  %UMINUS = fsub double -0.000000e+00, %Log10101
  %conv102 = fptosi double %UMINUS to i32
  %conv106 = sitofp i32 %conv102 to double
  %FCMP107 = fcmp ogt double %conv106, %UMINUS
  br i1 %FCMP107, label %phi.then103, label %phi.else104

phi.then103:                                      ; preds = %while.end93
  %MINUS108 = sub i32 %conv102, 1
  br label %phi.merge105

phi.else104:                                      ; preds = %while.end93
  br label %phi.merge105

phi.merge105:                                     ; preds = %phi.else104, %phi.then103
  %INL109 = phi i32 [ %MINUS108, %phi.then103 ], [ %conv102, %phi.else104 ]
  store i32 %INL109, i32* @OStrings_maxDig
  %lda110 = load i32, i32* @OStrings_maxDig
  %conv111 = sitofp i32 %lda110 to double
  %RealPower = call double @pow(double 1.000000e+01, double %conv111)
  ...
  %lda112 = load %SYSTEM_DLINK*, %SYSTEM_DLINK** @Kernel_dLink
  %next113 = getelementptr inbounds %SYSTEM_DLINK, %SYSTEM_DLINK* %lda112, i32 0, i32 0
  %lda114 = load %SYSTEM_DLINK*, %SYSTEM_DLINK** %next113
  store %SYSTEM_DLINK* %lda114, %SYSTEM_DLINK** @Kernel_dLink
  ret void
}
