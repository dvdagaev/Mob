...
phi.merge:                                        ; preds = %phi.else, %phi.then
  ...
  %IPCAST6 = inttoptr i64 %MINUS5 to i64 (%"Times_Hook^"*)**
...
phi.merge:                                        ; preds = %phi.else, %phi.then
  ...
  %IPCAST8 = inttoptr i64 %MINUS7 to void (%"Times_Hook^"*, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i64*, i32*)**
  ...
  call void %lda9(%"Times_Hook^"* %lda4, %Times_SystemTime* %st, %SYSTEM_TYPEDESC* bitcast (i64* getelementptr inbounds ([23 x i64], [23 x i64]* @Times_SystemTime__recdesc, i32 0, i32 2) to %SYSTEM_TYPEDESC*), i64* %t, i32* %res)
...
phi.merge:                                        ; preds = %phi.else, %phi.then
  ...
  %IPCAST8 = inttoptr i64 %MINUS7 to void (%"Times_Hook^"*, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i64*, i32*)**
  %lda9 = load void (%"Times_Hook^"*, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i64*, i32*)*, void (%"Times_Hook^"*, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i64*, i32*)** %IPCAST8
  call void %lda9(%"Times_Hook^"* %lda4, %Times_SystemTime* %lt, %SYSTEM_TYPEDESC* bitcast (i64* getelementptr inbounds ([23 x i64], [23 x i64]* @Times_SystemTime__recdesc, i32 0, i32 2) to %SYSTEM_TYPEDESC*), i64* %t, i32* %res)
  %lda10 = load %SYSTEM_DLINK*, %SYSTEM_DLINK** @Kernel_dLink
  %next11 = getelementptr inbounds %SYSTEM_DLINK, %SYSTEM_DLINK* %lda10, i32 0, i32 0
  %lda12 = load %SYSTEM_DLINK*, %SYSTEM_DLINK** %next11
  store %SYSTEM_DLINK* %lda12, %SYSTEM_DLINK** @Kernel_dLink
