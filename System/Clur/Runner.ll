...
%SYSTEM_MODDESC = type { %SYSTEM_MODDESC*, i32, i32, [6 x i16], [6 x i16], void ()*, void ()*, i32, i32, i64, i64, i64, i64, i64, i64, i64, i64, [913 x i8]*, [1 x i64]*, [5 x %SYSTEM_MODDESC*]*, %SYSTEM_DIRECTORY*, [256 x i8] }
...
%Runner_CHAR__array = type { [3 x i64], [1 x i64], [1 x i16] }
...
@Runner___1 = private global [4 x i64] [i64 256, i64 ptrtoint (%SYSTEM_MODDESC* @Runner__desc to i64), i64 233730, i64 3]
...
@Runner___3 = private global [4 x i64] [i64 6, i64 ptrtoint (%SYSTEM_MODDESC* @Runner__desc to i64), i64 234754, i64 ptrtoint ([21 x i64]* @Runner_Name__desc to i64)]
...
entry:
  ...
  call void @llvm.memset.p0i8.i64(i8* %PCAST, i8 0, i64 8, i32 0, i1 false)
  %Kernel_NewArr = call i64 @Kernel_NewArr(i64 9, i32 %name__len, i32 1)
  %IPCAST = inttoptr i64 %Kernel_NewArr to %Runner_CHAR__array*
  ...
  %INDX5 = getelementptr inbounds [1 x i64], [1 x i64]* %len4, i32 0, i32 0
  %lda6 = load i64, i64* %INDX5
  %cnv = trunc i64 %lda6 to i32
  ...
  call void @Kernel_StrcpyTL([0 x i16]* %atmp, i32 %PLUS, [0 x i16]* %PCAST9, i32 %cnv, i32 -1)
...
while.end:                                        ; preds = %while.cond
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast ([260 x i16]* @Runner_exeLocation to i8*), i8* %PCAST13, i64 4, i32 0, i1 false)
