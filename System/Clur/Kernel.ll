...
%SYSTEM_MODDESC = type { %SYSTEM_MODDESC*, i32, i32, [6 x i16], [6 x i16], void ()*, void ()*, i32, i32, i64, i64, i64, i64, i64, i64, i64, i64, [1931 x i8]*, [4 x i64]*, [3 x %SYSTEM_MODDESC*]*, %SYSTEM_DIRECTORY*, [256 x i8] }
%SYSTEM_DIRECTORY = type { i64, [99 x %SYSTEM_OBJDESC] }
...
@Kernel_Utf8Name__desc = global [21 x i64] [i64 256, i64 ptrtoint (%SYSTEM_MODDESC* @Kernel__desc to i64), i64 333314, i64 2, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0]
...
@Kernel___12 = private global [4 x i64] [i64 256, i64 ptrtoint (%SYSTEM_MODDESC* @Kernel__desc to i64), i64 494338, i64 3]
...
@Kernel_PtrType__recdesc__flds = private global { i64, [1 x %SYSTEM_OBJDESC] } { i64 1, [1 x %SYSTEM_OBJDESC] [%SYSTEM_OBJDESC { i32 0, i64 0, i32 442133, i64 13 }] }
...
@Kernel_Char8Type__recdesc__flds = private global { i64, [1 x %SYSTEM_OBJDESC] } { i64 1, [1 x %SYSTEM_OBJDESC] [%SYSTEM_OBJDESC { i32 0, i64 0, i32 442133, i64 2 }] }
...
@Kernel_Char16Type__recdesc__flds = private global { i64, [1 x %SYSTEM_OBJDESC] } { i64 1, [1 x %SYSTEM_OBJDESC] [%SYSTEM_OBJDESC { i32 0, i64 0, i32 442133, i64 3 }] }
...
@Kernel_Int8Type__recdesc__flds = private global { i64, [1 x %SYSTEM_OBJDESC] } { i64 1, [1 x %SYSTEM_OBJDESC] [%SYSTEM_OBJDESC { i32 0, i64 0, i32 442133, i64 4 }] }
...
@Kernel_Int16Type__recdesc__flds = private global { i64, [1 x %SYSTEM_OBJDESC] } { i64 1, [1 x %SYSTEM_OBJDESC] [%SYSTEM_OBJDESC { i32 0, i64 0, i32 442133, i64 5 }] }
...
@Kernel_Int32Type__recdesc__flds = private global { i64, [1 x %SYSTEM_OBJDESC] } { i64 1, [1 x %SYSTEM_OBJDESC] [%SYSTEM_OBJDESC { i32 0, i64 0, i32 442133, i64 6 }] }
...
@Kernel_Int64Type__recdesc__flds = private global { i64, [1 x %SYSTEM_OBJDESC] } { i64 1, [1 x %SYSTEM_OBJDESC] [%SYSTEM_OBJDESC { i32 0, i64 0, i32 442133, i64 10 }] }
...
@Kernel_BoolType__recdesc__flds = private global { i64, [1 x %SYSTEM_OBJDESC] } { i64 1, [1 x %SYSTEM_OBJDESC] [%SYSTEM_OBJDESC { i32 0, i64 0, i32 442133, i64 1 }] }
...
@Kernel_SetType__recdesc__flds = private global { i64, [1 x %SYSTEM_OBJDESC] } { i64 1, [1 x %SYSTEM_OBJDESC] [%SYSTEM_OBJDESC { i32 0, i64 0, i32 442133, i64 9 }] }
...
@Kernel_Real32Type__recdesc__flds = private global { i64, [1 x %SYSTEM_OBJDESC] } { i64 1, [1 x %SYSTEM_OBJDESC] [%SYSTEM_OBJDESC { i32 0, i64 0, i32 442133, i64 7 }] }
...
@Kernel_Real64Type__recdesc__flds = private global { i64, [1 x %SYSTEM_OBJDESC] } { i64 1, [1 x %SYSTEM_OBJDESC] [%SYSTEM_OBJDESC { i32 0, i64 0, i32 442133, i64 8 }] }
...
@Kernel_ProcType__recdesc__flds = private global { i64, [1 x %SYSTEM_OBJDESC] } { i64 1, [1 x %SYSTEM_OBJDESC] [%SYSTEM_OBJDESC { i32 0, i64 0, i32 442133, i64 16 }] }
...
@Kernel_UPtrType__recdesc__flds = private global { i64, [1 x %SYSTEM_OBJDESC] } { i64 1, [1 x %SYSTEM_OBJDESC] [%SYSTEM_OBJDESC { i32 0, i64 0, i32 442133, i64 6 }] }
...
@Kernel_AddrRange__recdesc__flds = private global { i64, [2 x %SYSTEM_OBJDESC] } { i64 2, [2 x %SYSTEM_OBJDESC] [%SYSTEM_OBJDESC { i32 0, i64 0, i32 339733, i64 10 }, %SYSTEM_OBJDESC { i32 0, i64 8, i32 338197, i64 10 }] }
...
phi.merge16:                                      ; preds = %phi.else15, %phi.then14
  ...
  %mprotect = call i32 @mprotect(i64 %PICAST, i64 %lda20, i32 3)
  %conv = sext i32 %mprotect to i64
  store i64 %conv, i64* %adr
...
declare i32 @mprotect(i64, i64, i32)
...
if.end:                                           ; preds = %if.end71, %if.end21
  %lda103 = load %"Kernel_DLink^"*, %"Kernel_DLink^"** @Kernel_dLink
  %next104 = getelementptr inbounds %"Kernel_DLink^", %"Kernel_DLink^"* %lda103, i32 0, i32 0
  %lda105 = load %"Kernel_DLink^"*, %"Kernel_DLink^"** %next104
  store %"Kernel_DLink^"* %lda105, %"Kernel_DLink^"** @Kernel_dLink
...
if.then8:                                         ; preds = %phi.merge
  %calloc = call i64 @calloc(i64 1, i64 65536)
  store i64 %calloc, i64* %adr
  br label %if.end9
...
if.then12:                                        ; preds = %if.end9
  %lda17 = load i64, i64* %size2
  %calloc18 = call i64 @calloc(i64 1, i64 %lda17)
  store i64 %calloc18, i64* %adr
  br label %if.end14

if.else13:                                        ; preds = %if.end9
  store i64 65536, i64* %size2
  br label %if.end14

if.end14:                                         ; preds = %if.else13, %if.then12
  %lda22 = load i64, i64* %adr
  %ICMP23 = icmp eq i64 %lda22, 0
...
if.else20:                                        ; preds = %if.end14
  %lda24 = load i64, i64* %adr
  %PLUS25 = add i64 %lda24, 15
  %DIV = sdiv i64 %PLUS25, 16
  %ICMP29 = icmp sge i64 %PLUS25, 0
  br i1 %ICMP29, label %phi.then26, label %phi.else27

if.end21:                                         ; preds = %phi.merge28, %if.then19
  br label %if.end

phi.then26:                                       ; preds = %if.else20
  br label %phi.merge28

phi.else27:                                       ; preds = %if.else20
  %MINUS = sub i64 %DIV, 1
  br label %phi.merge28

phi.merge28:                                      ; preds = %phi.else27, %phi.then26
  %INL30 = phi i64 [ %DIV, %phi.then26 ], [ %MINUS, %phi.else27 ]
  %TIMES = mul i64 %INL30, 16
  ...
  %max = getelementptr inbounds %"Kernel_Cluster^", %"Kernel_Cluster^"* %lda31, i32 0, i32 2
  %lda32 = load i64, i64* %adr
  store i64 %lda32, i64* %max
  %lda33 = load %"Kernel_Cluster^"*, %"Kernel_Cluster^"** %c
  %size34 = getelementptr inbounds %"Kernel_Cluster^", %"Kernel_Cluster^"* %lda33, i32 0, i32 0
  %lda35 = load i64, i64* %size2
  %lda36 = load %"Kernel_Cluster^"*, %"Kernel_Cluster^"** %c
  %PICAST = ptrtoint %"Kernel_Cluster^"* %lda36 to i64
  %lda37 = load i64, i64* %adr
  %MINUS38 = sub i64 %PICAST, %lda37
  %MINUS39 = sub i64 %lda35, %MINUS38
  store i64 %MINUS39, i64* %size34
  %lda40 = load %"Kernel_Cluster^"*, %"Kernel_Cluster^"** %c
  %size41 = getelementptr inbounds %"Kernel_Cluster^", %"Kernel_Cluster^"* %lda40, i32 0, i32 0
  %lda42 = load i64, i64* %size41
  %lda43 = load i64, i64* @Kernel_nUsed
  %PLUS44 = add i64 %lda43, %lda42
  store i64 %PLUS44, i64* @Kernel_nUsed
  %lda45 = load %"Kernel_Cluster^"*, %"Kernel_Cluster^"** %c
  %size46 = getelementptr inbounds %"Kernel_Cluster^", %"Kernel_Cluster^"* %lda45, i32 0, i32 0
  %lda47 = load i64, i64* %size46
  %lda48 = load i64, i64* @Kernel_nTotal
  %PLUS49 = add i64 %lda48, %lda47
  store i64 %PLUS49, i64* @Kernel_nTotal
  br label %if.end21

repeat.body:                                      ; preds = %repeat.cond, %if.else
  %lda50 = load i64, i64* %s
  %mmap = call i64 @mmap(i64 16777216, i64 %lda50, i32 0, i32 34, i32 -1, i64 0)
  store i64 %mmap, i64* %adr
  %lda53 = load i64, i64* %adr
  %ICMP54 = icmp eq i64 %lda53, 0
  br i1 %ICMP54, label %if.then51, label %if.end52

repeat.cond:                                      ; preds = %phi.merge61
  %lda65 = load i64, i64* %adr
  %ICMP66 = icmp ne i64 %lda65, 0
  %lda67 = load i64, i64* %s
  %ICMP68 = icmp eq i64 %lda67, 0
  %OR = or i1 %ICMP66, %ICMP68
  br i1 %OR, label %repeat.end, label %repeat.body

repeat.end:                                       ; preds = %repeat.cond
  %lda72 = load i64, i64* %adr
  %ICMP73 = icmp eq i64 %lda72, 0
  br i1 %ICMP73, label %if.then69, label %if.else70

if.then51:                                        ; preds = %repeat.body
  %lda55 = load i64, i64* %s
  %mmap56 = call i64 @mmap(i64 0, i64 %lda55, i32 0, i32 34, i32 -1, i64 0)
  store i64 %mmap56, i64* %adr
  br label %if.end52

if.end52:                                         ; preds = %if.then51, %repeat.body
  %lda57 = load i64, i64* %s
  %DIV58 = sdiv i64 %lda57, 2
  %ICMP62 = icmp sge i64 %lda57, 0
  br i1 %ICMP62, label %phi.then59, label %phi.else60

phi.then59:                                       ; preds = %if.end52
  br label %phi.merge61

phi.else60:                                       ; preds = %if.end52
  %MINUS63 = sub i64 %DIV58, 1
  br label %phi.merge61

phi.merge61:                                      ; preds = %phi.else60, %phi.then59
  %INL64 = phi i64 [ %DIV58, %phi.then59 ], [ %MINUS63, %phi.else60 ]
  store i64 %INL64, i64* %s
  br label %repeat.cond

if.then69:                                        ; preds = %repeat.end
  store %"Kernel_Cluster^"* null, %"Kernel_Cluster^"** %c
  br label %if.end71

if.else70:                                        ; preds = %repeat.end
  %lda76 = load i64, i64* %adr
  %mprotect = call i32 @mprotect(i64 %lda76, i64 1024, i32 3)
  %ICMP77 = icmp slt i32 %mprotect, 0
  br i1 %ICMP77, label %if.then74, label %if.end75

if.end71:                                         ; preds = %if.end97, %if.then69
  br label %if.end
...
phi.then81:                                       ; preds = %if.end75
  br label %phi.merge83

phi.else82:                                       ; preds = %if.end75
  call void @llvm.trap()
  br label %phi.merge83
...
entry:
  ...
  %ICMP = icmp sgt i64 %PLUS, 4000000
  %lda5 = load %"Kernel_DLink^"*, %"Kernel_DLink^"** @Kernel_dLink
  %next6 = getelementptr inbounds %"Kernel_DLink^", %"Kernel_DLink^"* %lda5, i32 0, i32 0
  %lda7 = load %"Kernel_DLink^"*, %"Kernel_DLink^"** %next6
  store %"Kernel_DLink^"* %lda7, %"Kernel_DLink^"** @Kernel_dLink
