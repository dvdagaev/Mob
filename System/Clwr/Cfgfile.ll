...
%SYSTEM_MODDESC = type { %SYSTEM_MODDESC*, i32, i32, [6 x i16], [6 x i16], void ()*, void ()*, i32, i32, i64, i64, i64, i64, i64, i64, i64, i64, [321 x i8]*, [2 x i64]*, [2 x %SYSTEM_MODDESC*]*, %SYSTEM_DIRECTORY*, [256 x i8] }
%SYSTEM_DIRECTORY = type { i64, [16 x %SYSTEM_OBJDESC] }
%SYSTEM_OBJDESC = type { i32, i64, i32, i64 }
%"Cfgfile_Directory^" = type {}
%SYSTEM_DLINK = type { %SYSTEM_DLINK*, %SYSTEM_MODDESC*, i32 }
%"Cfgfile_TxtReader^" = type { i1, [7 x i8], %"Files_Reader^"* }
...
@Cfgfile__ptrs = private global [2 x i64] zeroinitializer
@Cfgfile__exp = private global %SYSTEM_DIRECTORY { i64 16, [16 x %SYSTEM_OBJDESC] [%SYSTEM_OBJDESC { i32 644860257, i64 1319292907, i32 4674, i64 ptrtoint (i64* getelementptr inbounds ([23 x i64], [23 x i64]* @Cfgfile_Data__recdesc, i32 0, i32 2) to i64) }, %SYSTEM_OBJDESC { i32 -818642879, i64 -818642879, i32 11330, i64 ptrtoint ([21 x i64]* @Cfgfile_Directory__desc to i64) }, %SYSTEM_OBJDESC { i32 1480360609, i64 838494663, i32 13842, i64 ptrtoint (i64* getelementptr inbounds ([24 x i64], [24 x i64]* @Cfgfile_Directory__redesc, i32 0, i32 3) to i64) }, %SYSTEM_OBJDESC { i32 -1677000712, i64 0, i32 18241, i64 0 }, %SYSTEM_OBJDESC { i32 -1786198890, i64 0, i32 21313, i64 0 }, %SYSTEM_OBJDESC { i32 -1731468721, i64 0, i32 23873, i64 0 }, %SYSTEM_OBJDESC { i32 -1857431263, i64 0, i32 27713, i64 0 }, %SYSTEM_OBJDESC { i32 90518789, i64 ptrtoint (%"Cfgfile_Reader^"* (%"Files_Reader^"*)* @Cfgfile_NewReader to i64), i32 30020, i64 0 }, %SYSTEM_OBJDESC { i32 1662603767, i64 1662603767, i32 32578, i64 ptrtoint ([21 x i64]* @Cfgfile_Reader__desc to i64) }, %SYSTEM_OBJDESC { i32 -2073845381, i64 742570024, i32 34322, i64 ptrtoint (i64* getelementptr inbounds ([25 x i64], [25 x i64]* @Cfgfile_Reader__redesc, i32 0, i32 4) to i64) }, %SYSTEM_OBJDESC { i32 1477768406, i64 ptrtoint (void ()* @Cfgfile_ResetDir to i64), i32 36420, i64 0 }, %SYSTEM_OBJDESC { i32 998783814, i64 ptrtoint (void (%"Cfgfile_Directory^"*)* @Cfgfile_SetDir to i64), i32 38724, i64 0 }, %SYSTEM_OBJDESC { i32 -259865535, i64 ptrtoint (void ([0 x i16]*, i32)* @Cfgfile_SetTypeExtension to i64), i32 40516, i64 0 }, %SYSTEM_OBJDESC { i32 -8093308, i64 390021153, i32 48146, i64 ptrtoint (i64* getelementptr inbounds ([24 x i64], [24 x i64]* @Cfgfile_TxtDirectory__redesc, i32 0, i32 3) to i64) }, %SYSTEM_OBJDESC { i32 1286619643, i64 -570913427, i32 54290, i64 ptrtoint (i64* getelementptr inbounds ([26 x i64], [26 x i64]* @Cfgfile_TxtReader__redesc, i32 0, i32 4) to i64) }, %SYSTEM_OBJDESC { i32 -1811994356, i64 ptrtoint ([16 x i16]* @Cfgfile_cfgType to i64), i32 58915, i64 ptrtoint ([21 x i64]* @Files_Type__desc to i64) }] }
@Cfgfile__desc = global %SYSTEM_MODDESC { %SYSTEM_MODDESC* null, i32 3, i32 0, [6 x i16] [i16 2019, i16 7, i16 17, i16 16, i16 46, i16 14], [6 x i16] zeroinitializer, void ()* @Cfgfile__body, void ()* null, i32 1, i32 2, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, [321 x i8]* @Cfgfile__names, [2 x i64]* @Cfgfile__ptrs, [2 x %SYSTEM_MODDESC*]* @Cfgfile__imp, %SYSTEM_DIRECTORY* @Cfgfile__exp, [256 x i8] c"Cfgfile\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00" }
@Cfgfile_Data__recdesc = global [23 x i64] [i64 -1, i64 0, i64 1028, i64 ptrtoint (%SYSTEM_MODDESC* @Cfgfile__desc to i64), i64 4609, i64 ptrtoint (i64* getelementptr inbounds ([23 x i64], [23 x i64]* @Cfgfile_Data__recdesc, i32 0, i32 2) to i64), i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 ptrtoint ({ i64, [3 x %SYSTEM_OBJDESC] }* @Cfgfile_Data__recdesc__flds to i64), i64 -8]
@Cfgfile_Data__recdesc__flds = private global { i64, [3 x %SYSTEM_OBJDESC] } { i64 3, [3 x %SYSTEM_OBJDESC] [%SYSTEM_OBJDESC { i32 0, i64 0, i32 1861, i64 0 }, %SYSTEM_OBJDESC { i32 0, i64 512, i32 3141, i64 0 }, %SYSTEM_OBJDESC { i32 0, i64 1024, i32 325, i64 6 }] }
@Files_Name__desc = external global [21 x i64]
@Cfgfile_Reader__redesc = global [25 x i64] [i64 -1, i64 0, i64 0, i64 0, i64 1, i64 ptrtoint (%SYSTEM_MODDESC* @Cfgfile__desc to i64), i64 34317, i64 ptrtoint (i64* getelementptr inbounds ([25 x i64], [25 x i64]* @Cfgfile_Reader__redesc, i32 0, i32 4) to i64), i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 ptrtoint ({ i64, [1 x %SYSTEM_OBJDESC] }* @Cfgfile_Reader__redesc__flds to i64), i64 -8]
@Cfgfile_Reader__redesc__flds = private global { i64, [1 x %SYSTEM_OBJDESC] } { i64 1, [1 x %SYSTEM_OBJDESC] [%SYSTEM_OBJDESC { i32 0, i64 0, i32 8773, i64 1 }] }
@Cfgfile_Directory__redesc = global [24 x i64] [i64 -1, i64 0, i64 0, i64 1, i64 ptrtoint (%SYSTEM_MODDESC* @Cfgfile__desc to i64), i64 13837, i64 ptrtoint (i64* getelementptr inbounds ([24 x i64], [24 x i64]* @Cfgfile_Directory__redesc, i32 0, i32 3) to i64), i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 ptrtoint ({ i64, [0 x %SYSTEM_OBJDESC] }* @Cfgfile_Directory__redesc__flds to i64), i64 -8]
@Cfgfile_Directory__redesc__flds = private global { i64, [0 x %SYSTEM_OBJDESC] } zeroinitializer
@Cfgfile_TxtReader__redesc = global [26 x i64] [i64 -1, i64 ptrtoint (void (%"Cfgfile_TxtReader^"*)* @Cfgfile_TxtReader_Rewind to i64), i64 ptrtoint (void (%"Cfgfile_TxtReader^"*, %Cfgfile_Data*, %SYSTEM_TYPEDESC*, i1*)* @Cfgfile_TxtReader_Read to i64), i64 0, i64 16, i64 ptrtoint (%SYSTEM_MODDESC* @Cfgfile__desc to i64), i64 54289, i64 ptrtoint (i64* getelementptr inbounds ([25 x i64], [25 x i64]* @Cfgfile_Reader__redesc, i32 0, i32 4) to i64), i64 ptrtoint (i64* getelementptr inbounds ([26 x i64], [26 x i64]* @Cfgfile_TxtReader__redesc, i32 0, i32 4) to i64), i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 ptrtoint ({ i64, [1 x %SYSTEM_OBJDESC] }* @Cfgfile_TxtReader__redesc__flds to i64), i64 8, i64 -16]
@Cfgfile_TxtReader__desc = private global [21 x i64] [i64 0, i64 ptrtoint (%SYSTEM_MODDESC* @Cfgfile__desc to i64), i64 51715, i64 ptrtoint (i64* getelementptr inbounds ([26 x i64], [26 x i64]* @Cfgfile_TxtReader__redesc, i32 0, i32 4) to i64), i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0]
@Cfgfile_TxtReader__redesc__flds = private global { i64, [1 x %SYSTEM_OBJDESC] } { i64 1, [1 x %SYSTEM_OBJDESC] [%SYSTEM_OBJDESC { i32 0, i64 8, i32 10261, i64 ptrtoint ([21 x i64]* @Files_Reader__desc to i64) }] }
@Files_Reader__desc = external global [21 x i64]
@Files_Reader__redesc = external global [28 x i64]
@Cfgfile_TxtDirectory__redesc = global [24 x i64] [i64 -1, i64 ptrtoint (%"Cfgfile_Reader^"* (%"Cfgfile_TxtDirectory^"*, %"Files_Reader^"*)* @Cfgfile_TxtDirectory_NewReader to i64), i64 0, i64 1, i64 ptrtoint (%SYSTEM_MODDESC* @Cfgfile__desc to i64), i64 48145, i64 ptrtoint (i64* getelementptr inbounds ([24 x i64], [24 x i64]* @Cfgfile_Directory__redesc, i32 0, i32 3) to i64), i64 ptrtoint (i64* getelementptr inbounds ([24 x i64], [24 x i64]* @Cfgfile_TxtDirectory__redesc, i32 0, i32 3) to i64), i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 ptrtoint ({ i64, [0 x %SYSTEM_OBJDESC] }* @Cfgfile_TxtDirectory__redesc__flds to i64), i64 -8]
@Cfgfile_TxtDirectory__desc = private global [21 x i64] [i64 0, i64 ptrtoint (%SYSTEM_MODDESC* @Cfgfile__desc to i64), i64 44803, i64 ptrtoint (i64* getelementptr inbounds ([24 x i64], [24 x i64]* @Cfgfile_TxtDirectory__redesc, i32 0, i32 3) to i64), i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0]
@Cfgfile_Reader__desc = global [21 x i64] [i64 0, i64 ptrtoint (%SYSTEM_MODDESC* @Cfgfile__desc to i64), i64 32515, i64 ptrtoint (i64* getelementptr inbounds ([25 x i64], [25 x i64]* @Cfgfile_Reader__redesc, i32 0, i32 4) to i64), i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0]
@Cfgfile_TxtDirectory__redesc__flds = private global { i64, [0 x %SYSTEM_OBJDESC] } zeroinitializer
@Files_Type__desc = external global [21 x i64]
@Cfgfile_cfgType = global [16 x i16] zeroinitializer
@Cfgfile_Directory__desc = global [21 x i64] [i64 0, i64 ptrtoint (%SYSTEM_MODDESC* @Cfgfile__desc to i64), i64 11267, i64 ptrtoint (i64* getelementptr inbounds ([24 x i64], [24 x i64]* @Cfgfile_Directory__redesc, i32 0, i32 3) to i64), i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0]
...
merge:                                            ; preds = %entry
  ...
  store i64 ptrtoint (%"Cfgfile_Directory^"** @Cfgfile_cfgDir to i64), i64* getelementptr inbounds ([2 x i64], [2 x i64]* @Cfgfile__ptrs, i32 0, i32 0)
  store i64 ptrtoint (%"Cfgfile_Directory^"** @Cfgfile_stdCfgDir to i64), i64* getelementptr inbounds ([2 x i64], [2 x i64]* @Cfgfile__ptrs, i32 0, i32 1)
...
entry:
  ...
  %PICAST = ptrtoint %"Files_Reader^"* %lda3 to i64
  ...
  %MINUS6 = sub i64 %PICAST5, 48
  %IPCAST7 = inttoptr i64 %MINUS6 to void (%"Files_Reader^"*, i32)**
...
entry:
  ...
  call void @llvm.memset.p0i8.i64(i8* %PCAST4, i8 0, i64 2, i32 0, i1 false)
  store i1 true, i1* %ok
...
if.end:                                           ; preds = %entry
  ...
  %PICAST = ptrtoint %"Files_Reader^"* %lda17 to i64
  %MINUS = sub i64 %PICAST, 8
  %IPCAST = inttoptr i64 %MINUS to %SYSTEM_TYPEDESC**
  %lda18 = load %SYSTEM_TYPEDESC*, %SYSTEM_TYPEDESC** %IPCAST
  %PICAST19 = ptrtoint %SYSTEM_TYPEDESC* %lda18 to i64
  %MINUS20 = sub i64 %PICAST19, 32
  %IPCAST21 = inttoptr i64 %MINUS20 to void (%"Files_Reader^"*, i8*)**
...
case.end:                                         ; preds = %case.else, %if.end112, %if.end98, %if.end77, %if.end45
  ...
  %PICAST128 = ptrtoint %"Files_Reader^"* %lda127 to i64
  %MINUS129 = sub i64 %PICAST128, 8
  %IPCAST130 = inttoptr i64 %MINUS129 to %SYSTEM_TYPEDESC**
  %lda131 = load %SYSTEM_TYPEDESC*, %SYSTEM_TYPEDESC** %IPCAST130
  %PICAST132 = ptrtoint %SYSTEM_TYPEDESC* %lda131 to i64
  %MINUS133 = sub i64 %PICAST132, 32
  %IPCAST134 = inttoptr i64 %MINUS133 to void (%"Files_Reader^"*, i8*)**
...
entry:
  ...
  %Kernel_NewRec = call i64 @Kernel_NewRec(i64 ptrtoint (i64* getelementptr inbounds ([26 x i64], [26 x i64]* @Cfgfile_TxtReader__redesc, i32 0, i32 4) to i64))
  %IPCAST = inttoptr i64 %Kernel_NewRec to %"Cfgfile_TxtReader^"*
...
phi.merge9:                                       ; preds = %phi.else8, %phi.then7
  ...
  %PICAST = ptrtoint %"Cfgfile_Directory^"* %lda11 to i64
  %MINUS = sub i64 %PICAST, 8
  %IPCAST = inttoptr i64 %MINUS to %SYSTEM_TYPEDESC**
  %lda13 = load %SYSTEM_TYPEDESC*, %SYSTEM_TYPEDESC** %IPCAST
  %PICAST14 = ptrtoint %SYSTEM_TYPEDESC* %lda13 to i64
  %MINUS15 = sub i64 %PICAST14, 16
  %IPCAST16 = inttoptr i64 %MINUS15 to %"Cfgfile_Reader^"* (%"Cfgfile_Directory^"*, %"Files_Reader^"*)**
...
entry:
  ...
  call void @llvm.memset.p0i8.i64(i8* %PCAST, i8 0, i64 8, i32 0, i1 false)
  %Kernel_NewRec = call i64 @Kernel_NewRec(i64 ptrtoint (i64* getelementptr inbounds ([24 x i64], [24 x i64]* @Cfgfile_TxtDirectory__redesc, i32 0, i32 3) to i64))
  %IPCAST = inttoptr i64 %Kernel_NewRec to %"Cfgfile_TxtDirectory^"*
