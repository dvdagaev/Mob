...
%SYSTEM_MODDESC = type { %SYSTEM_MODDESC*, i32, i32, [6 x i16], [6 x i16], void ()*, void ()*, i32, i32, i64, i64, i64, i64, i64, i64, i64, i64, [1005 x i8]*, [1 x i64]*, [5 x %SYSTEM_MODDESC*]*, %SYSTEM_DIRECTORY*, [256 x i8] }
%SYSTEM_DIRECTORY = type { i64, [56 x %SYSTEM_OBJDESC] }
...
%Runner_SHORTCHAR__array = type { [3 x i64], [1 x i64], [1 x i8] }
%Runner_SHORTCHAR__array.0 = type { [3 x i64], [1 x i64], [1 x i8] }
...
@Runner__exp = private global %SYSTEM_DIRECTORY { i64 56, [56 x %SYSTEM_OBJDESC] [%SYSTEM_OBJDESC { i32 -2074819194, i64 0, i32 321, i64 0 }, %SYSTEM_OBJDESC { i32 1527652995, i64 0, i32 2625, i64 0 }, %SYSTEM_OBJDESC { i32 1162441350, i64 0, i32 6465, i64 0 }, %SYSTEM_OBJDESC { i32 1384913389, i64 0, i32 9281, i64 0 }, %SYSTEM_OBJDESC { i32 1607417652, i64 0, i32 12865, i64 0 }, %SYSTEM_OBJDESC { i32 1099460401, i64 0, i32 15681, i64 0 }, %SYSTEM_OBJDESC { i32 547742217, i64 ptrtoint (void (i32)* @Runner_ArgAt to i64), i32 21316, i64 0 }, %SYSTEM_OBJDESC { i32 1477768406, i64 ptrtoint (void ()* @Runner_ArgFirst to i64), i32 22852, i64 0 }, %SYSTEM_OBJDESC { i32 2025014490, i64 ptrtoint (void ([0 x i8]*, i32, i32*)* @Runner_ArgFutureName to i64), i32 25156, i64 0 }, %SYSTEM_OBJDESC { i32 1477768406, i64 ptrtoint (void ()* @Runner_ArgNext to i64), i32 28740, i64 0 }, %SYSTEM_OBJDESC { i32 -2082806566, i64 1759636125, i32 36162, i64 ptrtoint (i64* getelementptr inbounds ([23 x i64], [23 x i64]* @Runner_ArgReader__recdesc, i32 0, i32 2) to i64) }, %SYSTEM_OBJDESC { i32 -1225827516, i64 -1225827516, i32 38722, i64 0 }, %SYSTEM_OBJDESC { i32 -1884472531, i64 -1884472531, i32 40002, i64 ptrtoint ([21 x i64]* @Runner_ArgvString__desc to i64) }, %SYSTEM_OBJDESC { i32 1657500717, i64 0, i32 42817, i64 0 }, %SYSTEM_OBJDESC { i32 -1665443370, i64 ptrtoint (void ([0 x i8]*, i32, [0 x i8]*, i32, i32*)* @Runner_ChDir to i64), i32 45124, i64 0 }, %SYSTEM_OBJDESC { i32 -1308620795, i64 935812558, i32 48146, i64 0 }, %SYSTEM_OBJDESC { i32 1176280905, i64 0, i32 49985, i64 0 }, %SYSTEM_OBJDESC { i32 -482696453, i64 ptrtoint (i32 ([0 x i64]*, i32, i64, i64, i64)* @Runner_EntryPoint to i64), i32 53316, i64 0 }, %SYSTEM_OBJDESC { i32 -1282326601, i64 ptrtoint (void ([0 x i8]*, i32, [0 x i8]*, i32, i1, i32*)* @Runner_Execute to i64), i32 56132, i64 0 }, %SYSTEM_OBJDESC { i32 -1811896183, i64 ptrtoint (i1 ([0 x i8]*, i32, i32*)* @Runner_IntOpt to i64), i32 63556, i64 0 }, %SYSTEM_OBJDESC { i32 513655453, i64 0, i32 65345, i64 0 }, %SYSTEM_OBJDESC { i32 806882055, i64 806882055, i32 80706, i64 ptrtoint ([21 x i64]* @Runner_LoaderHookProxy__desc to i64) }, %SYSTEM_OBJDESC { i32 -1009990352, i64 1586811161, i32 84754, i64 ptrtoint (i64* getelementptr inbounds ([24 x i64], [24 x i64]* @Runner_LoaderHookProxy__redesc, i32 0, i32 3) to i64) }, %SYSTEM_OBJDESC { i32 515586985, i64 ptrtoint (void ([0 x i8]*, i32)* @Runner_LogSString to i64), i32 89156, i64 0 }, %SYSTEM_OBJDESC { i32 -2074819194, i64 0, i32 91969, i64 0 }, %SYSTEM_OBJDESC { i32 1657500717, i64 0, i32 94273, i64 0 }, %SYSTEM_OBJDESC { i32 440658467, i64 440658467, i32 96578, i64 ptrtoint ([21 x i64]* @Runner_Name__desc to i64) }, %SYSTEM_OBJDESC { i32 -1832827417, i64 0, i32 99137, i64 0 }, %SYSTEM_OBJDESC { i32 -1360966918, i64 -1094570289, i32 104514, i64 ptrtoint (i64* getelementptr inbounds ([23 x i64], [23 x i64]* @Runner_OpVal__recdesc, i32 0, i32 2) to i64) }, %SYSTEM_OBJDESC { i32 -1893460011, i64 -1893460011, i32 106050, i64 0 }, %SYSTEM_OBJDESC { i32 -1756318886, i64 0, i32 107841, i64 0 }, %SYSTEM_OBJDESC { i32 1588855546, i64 1588855546, i32 112658, i64 ptrtoint ([21 x i64]* @Runner_PathSString__desc to i64) }, %SYSTEM_OBJDESC { i32 -1377856509, i64 -1377856509, i32 115778, i64 ptrtoint ([21 x i64]* @Runner_PathString__desc to i64) }, %SYSTEM_OBJDESC { i32 1477768406, i64 ptrtoint (void ()* @Runner_PrintVars to i64), i32 121412, i64 0 }, %SYSTEM_OBJDESC { i32 2073078807, i64 0, i32 123969, i64 0 }, %SYSTEM_OBJDESC { i32 503335404, i64 503335404, i32 128834, i64 ptrtoint ([21 x i64]* @Runner_RunProc__desc to i64) }, %SYSTEM_OBJDESC { i32 1314431261, i64 1314431261, i32 130882, i64 ptrtoint ([21 x i64]* @Kernel_Utf8Name__desc to i64) }, %SYSTEM_OBJDESC { i32 -764074971, i64 ptrtoint (void (%"Runner_LoaderHookProxy^"*)* @Runner_SetLoaderHookProxy to i64), i32 134212, i64 0 }, %SYSTEM_OBJDESC { i32 547742217, i64 ptrtoint (void (i32)* @Runner_SetResult to i64), i32 139076, i64 0 }, %SYSTEM_OBJDESC { i32 494939409, i64 ptrtoint (void (void ()*)* @Runner_SetRun to i64), i32 141636, i64 0 }, %SYSTEM_OBJDESC { i32 -675083739, i64 573642869, i32 146962, i64 ptrtoint (i64* getelementptr inbounds ([24 x i64], [24 x i64]* @Runner_StdLoaderHook__redesc, i32 0, i32 3) to i64) }, %SYSTEM_OBJDESC { i32 484583514, i64 ptrtoint (i1 ([0 x i8]*, i32, [0 x i8]*, i32)* @Runner_StringOpt to i64), i32 150852, i64 0 }, %SYSTEM_OBJDESC { i32 -1381620312, i64 ptrtoint (%"Kernel_Module^"* ([0 x i16]*, i32)* @Runner_ThisLoadedMod to i64), i32 153412, i64 0 }, %SYSTEM_OBJDESC { i32 -1929411824, i64 ptrtoint (i32* @Runner_argC to i64), i32 164387, i64 6 }, %SYSTEM_OBJDESC { i32 -1929411824, i64 ptrtoint (i32* @Runner_argC0 to i64), i32 165667, i64 6 }, %SYSTEM_OBJDESC { i32 1110960307, i64 ptrtoint (%Runner_ArgReader* @Runner_argReader to i64), i32 167203, i64 ptrtoint (i64* getelementptr inbounds ([23 x i64], [23 x i64]* @Runner_ArgReader__recdesc, i32 0, i32 2) to i64) }, %SYSTEM_OBJDESC { i32 383868264, i64 ptrtoint ([256 x i8]* @Runner_argV0 to i64), i32 169763, i64 ptrtoint ([21 x i64]* @Kernel_Utf8Name__desc to i64) }, %SYSTEM_OBJDESC { i32 -712558960, i64 ptrtoint ([260 x i16]* @Runner_currentDir to i64), i32 171299, i64 ptrtoint ([21 x i64]* @Runner_PathString__desc to i64) }, %SYSTEM_OBJDESC { i32 -712558960, i64 ptrtoint ([260 x i16]* @Runner_exeLocation to i64), i32 174115, i64 ptrtoint ([21 x i64]* @Runner_PathString__desc to i64) }, %SYSTEM_OBJDESC { i32 -712558960, i64 ptrtoint ([260 x i16]* @Runner_exeName to i64), i32 177187, i64 ptrtoint ([21 x i64]* @Runner_PathString__desc to i64) }, %SYSTEM_OBJDESC { i32 -712558960, i64 ptrtoint ([260 x i16]* @Runner_exePathName to i64), i32 179235, i64 ptrtoint ([21 x i64]* @Runner_PathString__desc to i64) }, %SYSTEM_OBJDESC { i32 -1929411824, i64 ptrtoint (i32* @Runner_loadedAs to i64), i32 184867, i64 6 }, %SYSTEM_OBJDESC { i32 -519212227, i64 ptrtoint ([6 x [64 x i16]]* @Runner_loadedNames to i64), i32 187171, i64 ptrtoint ([4 x i64]* @Runner___3 to i64) }, %SYSTEM_OBJDESC { i32 -1311093752, i64 ptrtoint (void ()** @Runner_runProc to i64), i32 192803, i64 ptrtoint ([21 x i64]* @Runner_RunProc__desc to i64) }, %SYSTEM_OBJDESC { i32 -1929411824, i64 ptrtoint (i32* @Runner_runResult to i64), i32 194851, i64 6 }, %SYSTEM_OBJDESC { i32 -1610877492, i64 ptrtoint (i1* @Runner_textTrapHandler to i64), i32 197411, i64 1 }] }
@Runner__desc = global %SYSTEM_MODDESC { %SYSTEM_MODDESC* null, i32 3, i32 0, [6 x i16] [i16 2020, i16 6, i16 26, i16 15, i16 55, i16 50], [6 x i16] zeroinitializer, void ()* @Runner__body, void ()* null, i32 4, i32 1, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, [1005 x i8]* @Runner__names, [1 x i64]* @Runner__ptrs, [5 x %SYSTEM_MODDESC*]* @Runner__imp, %SYSTEM_DIRECTORY* @Runner__exp, [256 x i8] c"Runner\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00" }
@Runner_ArgReader__recdesc = global [23 x i64] [i64 -1, i64 0, i64 268, i64 ptrtoint (%SYSTEM_MODDESC* @Runner__desc to i64), i64 36097, i64 ptrtoint (i64* getelementptr inbounds ([23 x i64], [23 x i64]* @Runner_ArgReader__recdesc, i32 0, i32 2) to i64), i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 ptrtoint ({ i64, [4 x %SYSTEM_OBJDESC] }* @Runner_ArgReader__recdesc__flds to i64), i64 -8]
@Runner_ArgReader__recdesc__flds = private global { i64, [4 x %SYSTEM_OBJDESC] } { i64 4, [4 x %SYSTEM_OBJDESC] [%SYSTEM_OBJDESC { i32 0, i64 0, i32 34597, i64 0 }, %SYSTEM_OBJDESC { i32 0, i64 256, i32 31781, i64 6 }, %SYSTEM_OBJDESC { i32 0, i64 260, i32 33557, i64 6 }, %SYSTEM_OBJDESC { i32 0, i64 264, i32 30757, i64 1 }] }
@Kernel_Utf8Name__desc = external global [21 x i64]
@Runner_OpVal__recdesc = global [23 x i64] [i64 -1, i64 0, i64 896, i64 ptrtoint (%SYSTEM_MODDESC* @Runner__desc to i64), i64 104449, i64 ptrtoint (i64* getelementptr inbounds ([23 x i64], [23 x i64]* @Runner_OpVal__recdesc, i32 0, i32 2) to i64), i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 ptrtoint ({ i64, [3 x %SYSTEM_OBJDESC] }* @Runner_OpVal__recdesc__flds to i64), i64 -8]
@Runner_OpVal__recdesc__flds = private global { i64, [3 x %SYSTEM_OBJDESC] } { i64 3, [3 x %SYSTEM_OBJDESC] [%SYSTEM_OBJDESC { i32 0, i64 0, i32 71717, i64 0 }, %SYSTEM_OBJDESC { i32 0, i64 128, i32 34597, i64 ptrtoint ([21 x i64]* @Kernel_Utf8Name__desc to i64) }, %SYSTEM_OBJDESC { i32 0, i64 384, i32 103461, i64 0 }] }
@Runner_Name__desc = global [21 x i64] [i64 64, i64 ptrtoint (%SYSTEM_MODDESC* @Runner__desc to i64), i64 96514, i64 3, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0]
@Runner_ArgvString__desc = global [21 x i64] [i64 256, i64 ptrtoint (%SYSTEM_MODDESC* @Runner__desc to i64), i64 39938, i64 3, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0]
@Kernel_Command__desc = external global [21 x i64]
@Runner_StdLoaderHook__redesc = global [24 x i64] [i64 -1, i64 ptrtoint (%"Kernel_Module^"* (%"Runner_StdLoaderHook^"*, [0 x i16]*, i32)* @Runner_StdLoaderHook_ThisMod to i64), i64 0, i64 1540, i64 ptrtoint (%SYSTEM_MODDESC* @Runner__desc to i64), i64 146977, i64 ptrtoint (i64* getelementptr inbounds ([23 x i64], [23 x i64]* @Kernel_Hook__redesc, i32 0, i32 2) to i64), i64 ptrtoint (i64* getelementptr inbounds ([24 x i64], [24 x i64]* @Kernel_LoaderHook__redesc, i32 0, i32 3) to i64), i64 ptrtoint (i64* getelementptr inbounds ([24 x i64], [24 x i64]* @Runner_StdLoaderHook__redesc, i32 0, i32 3) to i64), i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 ptrtoint ({ i64, [0 x %SYSTEM_OBJDESC] }* @Runner_StdLoaderHook__redesc__flds to i64), i64 -8]
@Runner_StdLoaderHook__desc = private global [21 x i64] [i64 0, i64 ptrtoint (%SYSTEM_MODDESC* @Runner__desc to i64), i64 143363, i64 ptrtoint (i64* getelementptr inbounds ([24 x i64], [24 x i64]* @Runner_StdLoaderHook__redesc, i32 0, i32 3) to i64), i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0]
...
@Runner_LoaderHookProxy__redesc = global [24 x i64] [i64 -1, i64 0, i64 0, i64 1540, i64 ptrtoint (%SYSTEM_MODDESC* @Runner__desc to i64), i64 84765, i64 ptrtoint (i64* getelementptr inbounds ([23 x i64], [23 x i64]* @Kernel_Hook__redesc, i32 0, i32 2) to i64), i64 ptrtoint (i64* getelementptr inbounds ([24 x i64], [24 x i64]* @Runner_LoaderHookProxy__redesc, i32 0, i32 3) to i64), i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 ptrtoint ({ i64, [4 x %SYSTEM_OBJDESC] }* @Runner_LoaderHookProxy__redesc__flds to i64), i64 -8]
@Runner_LoaderHookProxy__redesc__flds = private global { i64, [4 x %SYSTEM_OBJDESC] } { i64 4, [4 x %SYSTEM_OBJDESC] [%SYSTEM_OBJDESC { i32 0, i64 0, i32 79685, i64 6 }, %SYSTEM_OBJDESC { i32 0, i64 4, i32 75333, i64 ptrtoint ([4 x i64]* @Runner___1 to i64) }, %SYSTEM_OBJDESC { i32 0, i64 516, i32 73029, i64 ptrtoint ([4 x i64]* @Runner___1 to i64) }, %SYSTEM_OBJDESC { i32 0, i64 1028, i32 77893, i64 ptrtoint ([4 x i64]* @Runner___1 to i64) }] }
@Runner___1 = private global [4 x i64] [i64 256, i64 ptrtoint (%SYSTEM_MODDESC* @Runner__desc to i64), i64 257282, i64 3]
@Runner_loadedAs = global i32 0
@Runner_loadedNames = global [6 x [64 x i16]] zeroinitializer
@Runner_textTrapHandler = global i1 false
@Runner_RunProc__desc = global [21 x i64] [i64 0, i64 ptrtoint (%SYSTEM_MODDESC* @Runner__desc to i64), i64 128768, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0]
@Runner_runProc = global void ()* null
@Runner_runResult = global i32 0
@Runner_PathString__desc = global [21 x i64] [i64 260, i64 ptrtoint (%SYSTEM_MODDESC* @Runner__desc to i64), i64 115714, i64 3, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0]
...
@Runner_PathSString__desc = private global [21 x i64] [i64 260, i64 ptrtoint (%SYSTEM_MODDESC* @Runner__desc to i64), i64 112642, i64 2, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0]
...
@Runner___3 = private global [4 x i64] [i64 6, i64 ptrtoint (%SYSTEM_MODDESC* @Runner__desc to i64), i64 258306, i64 ptrtoint ([21 x i64]* @Runner_Name__desc to i64)]
...
merge:                                            ; preds = %entry
  ...
  %lda5 = load i64, i64* inttoptr (i64 sub (i64 ptrtoint (i64* getelementptr inbounds ([24 x i64], [24 x i64]* @Kernel_LoaderHook__redesc, i32 0, i32 3) to i64), i64 8) to i64*)
  store i64 %lda5, i64* getelementptr inbounds ([24 x i64], [24 x i64]* @Runner_StdLoaderHook__redesc, i32 0, i32 2)
  %lda6 = load i64, i64* inttoptr (i64 sub (i64 ptrtoint (i64* getelementptr inbounds ([23 x i64], [23 x i64]* @Kernel_Hook__redesc, i32 0, i32 2) to i64), i64 8) to i64*)
...
entry:
  ...
  %ThisMod = inttoptr i64 %MINUS6 to %"Kernel_Module^"* (%"Runner_LoaderHookProxy^"*, [0 x i16]*, i32)**
...
if.then:                                          ; preds = %entry
  %Kernel_NewArr = call i64 @Kernel_NewArr(i64 1, i32 %dst__len, i32 1)
  %IPCAST = inttoptr i64 %Kernel_NewArr to %Runner_SHORTCHAR__array*
  ...
  %INDX16 = getelementptr inbounds [1 x i64], [1 x i64]* %len15, i32 0, i32 0
  %lda17 = load i64, i64* %INDX16
  %cnv = trunc i64 %lda17 to i32
  %PCAST18 = bitcast [1 x i8]* %data to [0 x i8]*
  call void @Kernel_StrcpySS([0 x i8]* %dst, i32 %PLUS13, [0 x i8]* %PCAST18, i32 %cnv, i32 -1)
  ...
  %INDX25 = getelementptr inbounds [1 x i64], [1 x i64]* %len24, i32 0, i32 0
  %lda26 = load i64, i64* %INDX25
  %cnv27 = trunc i64 %lda26 to i32
  %PCAST28 = bitcast [1 x i8]* %data20 to [0 x i8]*
  call void @Kernel_StrapndSS([0 x i8]* %src, i32 %PLUS22, [0 x i8]* %PCAST28, i32 %cnv27, i32 -1)
  %lda29 = load %Runner_SHORTCHAR__array*, %Runner_SHORTCHAR__array** %_ptr__4
  %data30 = getelementptr inbounds %Runner_SHORTCHAR__array, %Runner_SHORTCHAR__array* %lda29, i32 0, i32 2
  %lda31 = load %Runner_SHORTCHAR__array*, %Runner_SHORTCHAR__array** %_ptr__4
  %data32 = getelementptr inbounds %Runner_SHORTCHAR__array, %Runner_SHORTCHAR__array* %lda31, i32 0, i32 2
  %PCAST33 = bitcast [1 x i8]* %data32 to [0 x i8]*
  %Kernel_StrlenS34 = call i32 @Kernel_StrlenS([0 x i8]* %PCAST33, i32 -1)
  %PLUS35 = add i32 %Kernel_StrlenS34, 1
  %PCAST36 = bitcast [1 x i8]* %data30 to [0 x i8]*
  call void @Kernel_StrcpySS([0 x i8]* %PCAST36, i32 %PLUS35, [0 x i8]* %dst, i32 %dst__len, i32 -1)
  br label %if.end

if.else:                                          ; preds = %entry
  %lda37 = load i32, i32* %lsrc
  %lda38 = load i32, i32* %lendst
  %ICMP39 = icmp slt i32 %lda37, %lda38
  %Kernel_HaltHandler = call i1 @Kernel_HaltHandler(i32 20, i1 %ICMP39, %SYSTEM_MODDESC* @Runner__desc, i32 0)
  br i1 %Kernel_HaltHandler, label %phi.then, label %phi.else

if.end:                                           ; preds = %while.end, %if.then
  %lda94 = load %SYSTEM_DLINK*, %SYSTEM_DLINK** @Kernel_dLink
  %next95 = getelementptr inbounds %SYSTEM_DLINK, %SYSTEM_DLINK* %lda94, i32 0, i32 0
  %lda96 = load %SYSTEM_DLINK*, %SYSTEM_DLINK** %next95
  store %SYSTEM_DLINK* %lda96, %SYSTEM_DLINK** @Kernel_dLink
  ret void
...
phi.merge:                                        ; preds = %phi.else, %phi.then
  %INL = phi i1 [ %Kernel_HaltHandler, %phi.then ], [ %Kernel_HaltHandler, %phi.else ]
  %lda40 = load i32, i32* %lsrc
  %lda41 = load i32, i32* %ldst
  %PLUS42 = add i32 %lda40, %lda41
  %lda43 = load i32, i32* %lendst
  %MINUS = sub i32 %PLUS42, %lda43
  %PLUS44 = add i32 %MINUS, 1
  store i32 %PLUS44, i32* %dlt
  store i32 0, i32* %j
  br label %while.cond

while.cond:                                       ; preds = %while.body, %phi.merge
  %lda45 = load i32, i32* %j
  %lda46 = load i32, i32* %ldst
  %lda47 = load i32, i32* %dlt
  %MINUS48 = sub i32 %lda46, %lda47
  %ICMP49 = icmp slt i32 %lda45, %MINUS48
  br i1 %ICMP49, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %lda50 = load i32, i32* %j
  %INDX51 = getelementptr inbounds [0 x i8], [0 x i8]* %dst, i32 0, i32 %lda50
  %lda52 = load i32, i32* %j
  %lda53 = load i32, i32* %dlt
  %PLUS54 = add i32 %lda52, %lda53
  %INDX55 = getelementptr inbounds [0 x i8], [0 x i8]* %dst, i32 0, i32 %PLUS54
  %lda56 = load i8, i8* %INDX55
  store i8 %lda56, i8* %INDX51
  %lda57 = load i32, i32* %j
  %PLUS58 = add i32 %lda57, 1
  store i32 %PLUS58, i32* %j
  br label %while.cond

while.end:                                        ; preds = %while.cond
  %lda59 = load i32, i32* %j
  %INDX60 = getelementptr inbounds [0 x i8], [0 x i8]* %dst, i32 0, i32 %lda59
  store i8 0, i8* %INDX60
  %Kernel_NewArr61 = call i64 @Kernel_NewArr(i64 1, i32 %dst__len, i32 1)
  %IPCAST62 = inttoptr i64 %Kernel_NewArr61 to %Runner_SHORTCHAR__array.0*
  %len63 = getelementptr inbounds %Runner_SHORTCHAR__array.0, %Runner_SHORTCHAR__array.0* %IPCAST62, i32 0, i32 1
  %INDX64 = getelementptr inbounds [1 x i64], [1 x i64]* %len63, i32 0, i32 0
  %SEXT65 = sext i32 %dst__len to i64
  store i64 %SEXT65, i64* %INDX64
  store %Runner_SHORTCHAR__array.0* %IPCAST62, %Runner_SHORTCHAR__array.0** %_ptr__3
  %lda66 = load %Runner_SHORTCHAR__array.0*, %Runner_SHORTCHAR__array.0** %_ptr__3
  %data67 = getelementptr inbounds %Runner_SHORTCHAR__array.0, %Runner_SHORTCHAR__array.0* %lda66, i32 0, i32 2
  %Kernel_StrlenS68 = call i32 @Kernel_StrlenS([0 x i8]* %dst, i32 -1)
  %PLUS69 = add i32 %Kernel_StrlenS68, 1
  %lda70 = load %Runner_SHORTCHAR__array.0*, %Runner_SHORTCHAR__array.0** %_ptr__3
  %len71 = getelementptr inbounds %Runner_SHORTCHAR__array.0, %Runner_SHORTCHAR__array.0* %lda70, i32 0, i32 1
  %INDX72 = getelementptr inbounds [1 x i64], [1 x i64]* %len71, i32 0, i32 0
  %lda73 = load i64, i64* %INDX72
  %cnv74 = trunc i64 %lda73 to i32
  %PCAST75 = bitcast [1 x i8]* %data67 to [0 x i8]*
  call void @Kernel_StrcpySS([0 x i8]* %dst, i32 %PLUS69, [0 x i8]* %PCAST75, i32 %cnv74, i32 -1)
  %lda76 = load %Runner_SHORTCHAR__array.0*, %Runner_SHORTCHAR__array.0** %_ptr__3
  %data77 = getelementptr inbounds %Runner_SHORTCHAR__array.0, %Runner_SHORTCHAR__array.0* %lda76, i32 0, i32 2
  %Kernel_StrlenS78 = call i32 @Kernel_StrlenS([0 x i8]* %src, i32 -1)
  %PLUS79 = add i32 %Kernel_StrlenS78, 1
  %lda80 = load %Runner_SHORTCHAR__array.0*, %Runner_SHORTCHAR__array.0** %_ptr__3
  %len81 = getelementptr inbounds %Runner_SHORTCHAR__array.0, %Runner_SHORTCHAR__array.0* %lda80, i32 0, i32 1
  %INDX82 = getelementptr inbounds [1 x i64], [1 x i64]* %len81, i32 0, i32 0
  %lda83 = load i64, i64* %INDX82
  %cnv84 = trunc i64 %lda83 to i32
  %PCAST85 = bitcast [1 x i8]* %data77 to [0 x i8]*
  call void @Kernel_StrapndSS([0 x i8]* %src, i32 %PLUS79, [0 x i8]* %PCAST85, i32 %cnv84, i32 -1)
  %lda86 = load %Runner_SHORTCHAR__array.0*, %Runner_SHORTCHAR__array.0** %_ptr__3
  %data87 = getelementptr inbounds %Runner_SHORTCHAR__array.0, %Runner_SHORTCHAR__array.0* %lda86, i32 0, i32 2
  %lda88 = load %Runner_SHORTCHAR__array.0*, %Runner_SHORTCHAR__array.0** %_ptr__3
  %data89 = getelementptr inbounds %Runner_SHORTCHAR__array.0, %Runner_SHORTCHAR__array.0* %lda88, i32 0, i32 2
  %PCAST90 = bitcast [1 x i8]* %data89 to [0 x i8]*
  %Kernel_StrlenS91 = call i32 @Kernel_StrlenS([0 x i8]* %PCAST90, i32 -1)
  %PLUS92 = add i32 %Kernel_StrlenS91, 1
  %PCAST93 = bitcast [1 x i8]* %data87 to [0 x i8]*
  call void @Kernel_StrcpySS([0 x i8]* %PCAST93, i32 %PLUS92, [0 x i8]* %dst, i32 %dst__len, i32 -1)
  br label %if.end
}

declare i64 @Kernel_NewArr(i64, i32, i32)
...
entry:
  ...
  %_popen = call i64 @_popen([0 x i8]* %PCAST7, [0 x i8]* %PCAST8)
  store i64 %_popen, i64* %f
  %lda9 = load i64, i64* %f
  %ICMP = icmp eq i64 %lda9, 0
  br i1 %ICMP, label %if.then, label %if.else
...
declare i64 @_popen([0 x i8]*, [0 x i8]*)

declare i32 @feof(i64)

declare i32 @fgets([0 x i8]*, i64, i64)

declare i32 @_pclose(i64)
