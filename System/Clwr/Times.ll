...
merge:                                            ; preds = %entry
  ...
  store i64 ptrtoint (%"Times_Hook^"** @Times_pHook to i64), i64* getelementptr inbounds ([1 x i64], [1 x i64]* @Times__ptrs, i32 0, i32 0)
...
phi.merge:                                        ; preds = %phi.else, %phi.then
  ...
  %PICAST = ptrtoint %"Times_Hook^"* %lda2 to i64
  %MINUS = sub i64 %PICAST, 8
  %IPCAST = inttoptr i64 %MINUS to %SYSTEM_TYPEDESC**
  %lda3 = load %SYSTEM_TYPEDESC*, %SYSTEM_TYPEDESC** %IPCAST
  %PICAST4 = ptrtoint %SYSTEM_TYPEDESC* %lda3 to i64
  %MINUS5 = sub i64 %PICAST4, 32
  %GetTime = inttoptr i64 %MINUS5 to i64 (%"Times_Hook^"*)**
  %lda6 = load i64 (%"Times_Hook^"*)*, i64 (%"Times_Hook^"*)** %GetTime
  %GetTime7 = call i64 %lda6(%"Times_Hook^"* %lda2)
...
phi.merge:                                        ; preds = %phi.else, %phi.then
  ...
  %ToSystemTime = inttoptr i64 %MINUS8 to void (%"Times_Hook^"*, i64, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i32*)**
  %lda9 = load void (%"Times_Hook^"*, i64, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i32*)*, void (%"Times_Hook^"*, i64, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i32*)** %ToSystemTime
  call void %lda9(%"Times_Hook^"* %lda4, i64 %lda5, %Times_SystemTime* %st, %SYSTEM_TYPEDESC* bitcast (i64* getelementptr inbounds ([23 x i64], [23 x i64]* @Times_SystemTime__recdesc, i32 0, i32 2) to %SYSTEM_TYPEDESC*), i32* %res)
...
phi.merge:                                        ; preds = %phi.else, %phi.then
  ...
  %ToLocalTime = inttoptr i64 %MINUS8 to void (%"Times_Hook^"*, i64, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i32*)**
  %lda9 = load void (%"Times_Hook^"*, i64, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i32*)*, void (%"Times_Hook^"*, i64, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i32*)** %ToLocalTime
  call void %lda9(%"Times_Hook^"* %lda4, i64 %lda5, %Times_SystemTime* %lt, %SYSTEM_TYPEDESC* bitcast (i64* getelementptr inbounds ([23 x i64], [23 x i64]* @Times_SystemTime__recdesc, i32 0, i32 2) to %SYSTEM_TYPEDESC*), i32* %res)
  %lda10 = load %SYSTEM_DLINK*, %SYSTEM_DLINK** @Kernel_dLink
  %next11 = getelementptr inbounds %SYSTEM_DLINK, %SYSTEM_DLINK* %lda10, i32 0, i32 0
  %lda12 = load %SYSTEM_DLINK*, %SYSTEM_DLINK** %next11
  store %SYSTEM_DLINK* %lda12, %SYSTEM_DLINK** @Kernel_dLink
...
phi.merge:                                        ; preds = %phi.else, %phi.then
  ...
  %FromSystemTime = inttoptr i64 %MINUS7 to void (%"Times_Hook^"*, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i64*, i32*)**
  %lda8 = load void (%"Times_Hook^"*, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i64*, i32*)*, void (%"Times_Hook^"*, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i64*, i32*)** %FromSystemTime
  call void %lda8(%"Times_Hook^"* %lda4, %Times_SystemTime* %st, %SYSTEM_TYPEDESC* bitcast (i64* getelementptr inbounds ([23 x i64], [23 x i64]* @Times_SystemTime__recdesc, i32 0, i32 2) to %SYSTEM_TYPEDESC*), i64* %t, i32* %res)
...
phi.merge:                                        ; preds = %phi.else, %phi.then
  ...
  %lda5 = load %SYSTEM_TYPEDESC*, %SYSTEM_TYPEDESC** %IPCAST
  %PICAST6 = ptrtoint %SYSTEM_TYPEDESC* %lda5 to i64
  %MINUS7 = sub i64 %PICAST6, 16
  %FromLocalTime = inttoptr i64 %MINUS7 to void (%"Times_Hook^"*, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i64*, i32*)**
  %lda8 = load void (%"Times_Hook^"*, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i64*, i32*)*, void (%"Times_Hook^"*, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i64*, i32*)** %FromLocalTime
  call void %lda8(%"Times_Hook^"* %lda4, %Times_SystemTime* %lt, %SYSTEM_TYPEDESC* bitcast (i64* getelementptr inbounds ([23 x i64], [23 x i64]* @Times_SystemTime__recdesc, i32 0, i32 2) to %SYSTEM_TYPEDESC*), i64* %t, i32* %res)
  %lda9 = load %SYSTEM_DLINK*, %SYSTEM_DLINK** @Kernel_dLink
  %next10 = getelementptr inbounds %SYSTEM_DLINK, %SYSTEM_DLINK* %lda9, i32 0, i32 0
  %lda11 = load %SYSTEM_DLINK*, %SYSTEM_DLINK** %next10
  store %SYSTEM_DLINK* %lda11, %SYSTEM_DLINK** @Kernel_dLink
...
phi.merge:                                        ; preds = %phi.else, %phi.then
  ...
  %GetUTCBias = inttoptr i64 %MINUS6 to void (%"Times_Hook^"*, i32*)**
  %lda7 = load void (%"Times_Hook^"*, i32*)*, void (%"Times_Hook^"*, i32*)** %GetUTCBias
  call void %lda7(%"Times_Hook^"* %lda3, i32* %bias)
  %lda8 = load %SYSTEM_DLINK*, %SYSTEM_DLINK** @Kernel_dLink
  %next9 = getelementptr inbounds %SYSTEM_DLINK, %SYSTEM_DLINK* %lda8, i32 0, i32 0
  %lda10 = load %SYSTEM_DLINK*, %SYSTEM_DLINK** %next9
  store %SYSTEM_DLINK* %lda10, %SYSTEM_DLINK** @Kernel_dLink
...
phi.merge:                                        ; preds = %phi.else, %phi.then
  ...
  %Sleep = inttoptr i64 %MINUS7 to void (%"Times_Hook^"*, i64)**
  %lda8 = load void (%"Times_Hook^"*, i64)*, void (%"Times_Hook^"*, i64)** %Sleep
  call void %lda8(%"Times_Hook^"* %lda3, i64 %lda4)
  %lda9 = load %SYSTEM_DLINK*, %SYSTEM_DLINK** @Kernel_dLink
  %next10 = getelementptr inbounds %SYSTEM_DLINK, %SYSTEM_DLINK* %lda9, i32 0, i32 0
  %lda11 = load %SYSTEM_DLINK*, %SYSTEM_DLINK** %next10
  store %SYSTEM_DLINK* %lda11, %SYSTEM_DLINK** @Kernel_dLink
...
if.then:                                          ; preds = %entry
  ...
  call void @Times_ToSystemTime(i64 %lda4, %Times_SystemTime* %st, %SYSTEM_TYPEDESC* bitcast (i64* getelementptr inbounds ([23 x i64], [23 x i64]* @Times_SystemTime__recdesc, i32 0, i32 2) to %SYSTEM_TYPEDESC*), i32* %res)
  br label %if.end

if.else:                                          ; preds = %entry
  %lda5 = load i64, i64* %t1
  call void @Times_ToLocalTime(i64 %lda5, %Times_SystemTime* %st, %SYSTEM_TYPEDESC* bitcast (i64* getelementptr inbounds ([23 x i64], [23 x i64]* @Times_SystemTime__recdesc, i32 0, i32 2) to %SYSTEM_TYPEDESC*), i32* %res)
  br label %if.end
...
if.then6:                                         ; preds = %if.end
  ...
  call void @Times_SystemTimeToString(%Times_SystemTime* %st, %SYSTEM_TYPEDESC* bitcast (i64* getelementptr inbounds ([23 x i64], [23 x i64]* @Times_SystemTime__recdesc, i32 0, i32 2) to %SYSTEM_TYPEDESC*), i32 %lda11, [0 x i16]* %s, i32 %s__len)
  br label %if.end8
...
if.else7:                                         ; preds = %if.end
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %PCAST12, i8* %PCAST13, i64 6, i32 0, i1 false)
  br label %if.end8
...
entry:
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast ([12 x [32 x i16]]* @Times_monNames to i8*), i8* %PCAST, i64 8, i32 0, i1 false)
  %atmp1 = alloca [9 x i8]
  store [9 x i8] c"F\00E\00B\00\00\00\00", [9 x i8]* %atmp1
  %PCAST2 = bitcast [9 x i8]* %atmp1 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast ([32 x i16]* getelementptr inbounds ([12 x [32 x i16]], [12 x [32 x i16]]* @Times_monNames, i32 0, i32 1) to i8*), i8* %PCAST2, i64 8, i32 0, i1 false)
  %atmp3 = alloca [9 x i8]
  store [9 x i8] c"M\00A\00R\00\00\00\00", [9 x i8]* %atmp3
  %PCAST4 = bitcast [9 x i8]* %atmp3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast ([32 x i16]* getelementptr inbounds ([12 x [32 x i16]], [12 x [32 x i16]]* @Times_monNames, i32 0, i32 2) to i8*), i8* %PCAST4, i64 8, i32 0, i1 false)
  %atmp5 = alloca [9 x i8]
  store [9 x i8] c"A\00P\00R\00\00\00\00", [9 x i8]* %atmp5
  %PCAST6 = bitcast [9 x i8]* %atmp5 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast ([32 x i16]* getelementptr inbounds ([12 x [32 x i16]], [12 x [32 x i16]]* @Times_monNames, i32 0, i32 3) to i8*), i8* %PCAST6, i64 8, i32 0, i1 false)
  %atmp7 = alloca [9 x i8]
  store [9 x i8] c"M\00A\00Y\00\00\00\00", [9 x i8]* %atmp7
  %PCAST8 = bitcast [9 x i8]* %atmp7 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast ([32 x i16]* getelementptr inbounds ([12 x [32 x i16]], [12 x [32 x i16]]* @Times_monNames, i32 0, i32 4) to i8*), i8* %PCAST8, i64 8, i32 0, i1 false)
  %atmp9 = alloca [9 x i8]
  store [9 x i8] c"J\00U\00N\00\00\00\00", [9 x i8]* %atmp9
  %PCAST10 = bitcast [9 x i8]* %atmp9 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast ([32 x i16]* getelementptr inbounds ([12 x [32 x i16]], [12 x [32 x i16]]* @Times_monNames, i32 0, i32 5) to i8*), i8* %PCAST10, i64 8, i32 0, i1 false)
  %atmp11 = alloca [9 x i8]
  store [9 x i8] c"J\00U\00L\00\00\00\00", [9 x i8]* %atmp11
  %PCAST12 = bitcast [9 x i8]* %atmp11 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast ([32 x i16]* getelementptr inbounds ([12 x [32 x i16]], [12 x [32 x i16]]* @Times_monNames, i32 0, i32 6) to i8*), i8* %PCAST12, i64 8, i32 0, i1 false)
  %atmp13 = alloca [9 x i8]
  store [9 x i8] c"A\00U\00G\00\00\00\00", [9 x i8]* %atmp13
  %PCAST14 = bitcast [9 x i8]* %atmp13 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast ([32 x i16]* getelementptr inbounds ([12 x [32 x i16]], [12 x [32 x i16]]* @Times_monNames, i32 0, i32 7) to i8*), i8* %PCAST14, i64 8, i32 0, i1 false)
  %atmp15 = alloca [9 x i8]
  store [9 x i8] c"S\00E\00P\00\00\00\00", [9 x i8]* %atmp15
  %PCAST16 = bitcast [9 x i8]* %atmp15 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast ([32 x i16]* getelementptr inbounds ([12 x [32 x i16]], [12 x [32 x i16]]* @Times_monNames, i32 0, i32 8) to i8*), i8* %PCAST16, i64 8, i32 0, i1 false)
  %atmp17 = alloca [9 x i8]
  store [9 x i8] c"O\00C\00T\00\00\00\00", [9 x i8]* %atmp17
  %PCAST18 = bitcast [9 x i8]* %atmp17 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast ([32 x i16]* getelementptr inbounds ([12 x [32 x i16]], [12 x [32 x i16]]* @Times_monNames, i32 0, i32 9) to i8*), i8* %PCAST18, i64 8, i32 0, i1 false)
  %atmp19 = alloca [9 x i8]
  store [9 x i8] c"N\00O\00V\00\00\00\00", [9 x i8]* %atmp19
  %PCAST20 = bitcast [9 x i8]* %atmp19 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast ([32 x i16]* getelementptr inbounds ([12 x [32 x i16]], [12 x [32 x i16]]* @Times_monNames, i32 0, i32 10) to i8*), i8* %PCAST20, i64 8, i32 0, i1 false)
  %atmp21 = alloca [9 x i8]
  store [9 x i8] c"D\00E\00C\00\00\00\00", [9 x i8]* %atmp21
  %PCAST22 = bitcast [9 x i8]* %atmp21 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast ([32 x i16]* getelementptr inbounds ([12 x [32 x i16]], [12 x [32 x i16]]* @Times_monNames, i32 0, i32 11) to i8*), i8* %PCAST22, i64 8, i32 0, i1 false)
