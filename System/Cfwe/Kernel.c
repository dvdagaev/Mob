...
static ADDRESS Kernel_Module__rec__flds[] = {
	...
	0, 92, 123<<8 | 0x25, 13,
	0, 96, 131<<8 | 0x25, 13,
	0, 100, 138<<8 | 0x25, (ADDRESS)Kernel_Name__desc,
};
export ADDRESS Kernel_Module__rec__desc[] = {
	-1, 
	356,
...
static ADDRESS Kernel_Type__rec__flds[] = {
	...
	0, 4, 205<<8 | 0x25, 13,
	0, 8, 209<<8 | 0x25, 6,
	0, 12, 212<<8 | 0x25, (ADDRESS)Kernel__9__desc,
	0, 76, 217<<8 | 0x25, 13,
	0, 80, 224<<8 | 0x25, (ADDRESS)Kernel__10__desc,
};
export ADDRESS Kernel_Type__rec__desc[] = {
	-1, 
	4080,
...
static ADDRESS Kernel__exp[] = {
	69, 
	0x7e3f9b47, 0xa9415040, 593<<8 | 0x12, (ADDRESS)(Kernel_AddrRange__desc + 2),
	0x779e2200, (ADDRESS)Kernel_Allocated, 640<<8 | 0x44, 0,
	0x7e2b5e91, 0x7e2b5e91, 611<<8 | 0x42, (ADDRESS)Kernel_Argv__desc,
	0x12ac22be, 0x1b8f6bee, 372<<8 | 0x12, 0,
	...
	0xb3c62b2c, 0xb8f34fd5, 402<<8 | 0x12, 0,
	...
	0xa905014a, 0x58fd60a7, 434<<8 | 0x12, (ADDRESS)(Kernel_FList__rec__desc + 2),
	0x5814f4d6, (ADDRESS)Kernel_FastCollect, 666<<8 | 0x44, 0,
	0x286ce031, 0x89306cce, 379<<8 | 0x12, 0,
	...
	0x03a3c9c9, 0x157e20bb, 339<<8 | 0x42, (ADDRESS)(Kernel_Identifier__desc + 3),
	...
	0x2e96a04d, (ADDRESS)Kernel_Main, 704<<8 | 0x44, 0,
	0xd95d10d4, 0xd95d10d4, 151<<8 | 0x42, 13,
	0xfcbd72d0, 0x30ed5919, 143<<8 | 0x12, 0,
	0x615636df, 0x615636df, 195<<8 | 0x42, (ADDRESS)Kernel_Name__desc,
	0x76068c78, (ADDRESS)Kernel_NewArr, 709<<8 | 0x44, 0,
	0x4e27a847, (ADDRESS)Kernel_NewRec, 716<<8 | 0x44, 0,
	0xa2646fa4, 0x4bc1d4f4, 262<<8 | 0x42, 0,
	0x9fc66595, 0x9fc66595, 603<<8 | 0x42, 13,
	0xa5e8a12e, 0x85389aca, 562<<8 | 0x12, (ADDRESS)(Kernel_ProcType__desc + 2),
	...
	0x1eeb84c7, 0x0afffa11, 318<<8 | 0x12, (ADDRESS)(Kernel_Reducer__rec__desc + 3),
	0x779e2200, (ADDRESS)Kernel_Root, 723<<8 | 0x44, 0,
	0x8ff1aca5, (ADDRESS)Kernel_SetLoaderHook, 728<<8 | 0x44, 0,
	0x4e27a847, (ADDRESS)Kernel_SetModList, 742<<8 | 0x44, 0,
	...
	0x779e2200, (ADDRESS)Kernel_Total, 786<<8 | 0x44, 0,
	0x4bf97443, 0x4bf97443, 238<<8 | 0x42, 13,
	0x281603d7, 0x88c7bc14, 232<<8 | 0x12, 0,
	0x68a9b79a, 0x7031ab41, 571<<8 | 0x12, (ADDRESS)(Kernel_UPtrType__desc + 2),
	0x779e2200, (ADDRESS)Kernel_Used, 792<<8 | 0x44, 0,
