...
%SYSTEM_MODDESC = type { %SYSTEM_MODDESC*, i32, i32, [6 x i16], [6 x i16], void ()*, void ()*, i32, i32, i64, i64, i64, i64, i64, i64, i64, i64, [189 x i8]*, [1 x i64]*, [3 x %SYSTEM_MODDESC*]*, %SYSTEM_DIRECTORY*, [256 x i8] }
...
@HostTimes__exp = private global %SYSTEM_DIRECTORY { i64 2, [2 x %SYSTEM_OBJDESC] [%SYSTEM_OBJDESC { i32 -1682067740, i64 -881725400, i32 3602, i64 0 }, %SYSTEM_OBJDESC { i32 -1351626827, i64 -2070047696, i32 6418, i64 ptrtoint (i64* getelementptr inbounds ([29 x i64], [29 x i64]* @HostTimes_Hook__redesc, i32 0, i32 8) to i64) }] }
@HostTimes__desc = global %SYSTEM_MODDESC { %SYSTEM_MODDESC* null, i32 3, i32 0, [6 x i16] [i16 2019, i16 5, i16 30, i16 13, i16 19, i16 35], [6 x i16] zeroinitializer, void ()* @HostTimes__body, void ()* null, i32 2, i32 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, [189 x i8]* @HostTimes__names, [1 x i64]* @HostTimes__ptrs, [3 x %SYSTEM_MODDESC*]* @HostTimes__imp, %SYSTEM_DIRECTORY* @HostTimes__exp, [256 x i8] c"HostTimes\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00" }
@HostTimes_Hook__redesc = global [29 x i64] [i64 -1, i64 ptrtoint (void (%"HostTimes_Hook^"*, i64, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i32*)* @HostTimes_Hook_ToSystemTime to i64), i64 ptrtoint (void (%"HostTimes_Hook^"*, i64, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i32*)* @HostTimes_Hook_ToLocalTime to i64), i64 ptrtoint (void (%"HostTimes_Hook^"*, i64)* @HostTimes_Hook_Sleep to i64), i64 ptrtoint (i64 (%"HostTimes_Hook^"*)* @HostTimes_Hook_GetTime to i64), i64 ptrtoint (void (%"HostTimes_Hook^"*, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i64*, i32*)* @HostTimes_Hook_FromSystemTime to i64), i64 ptrtoint (void (%"HostTimes_Hook^"*, %Times_SystemTime*, %SYSTEM_TYPEDESC*, i64*, i32*)* @HostTimes_Hook_FromLocalTime to i64), i64 0, i64 1, i64 ptrtoint (%SYSTEM_MODDESC* @HostTimes__desc to i64), i64 6417, i64 0, i64 ptrtoint (i64* getelementptr inbounds ([29 x i64], [29 x i64]* @HostTimes_Hook__redesc, i32 0, i32 8) to i64), i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 ptrtoint ({ i64, [0 x %SYSTEM_OBJDESC] }* @HostTimes_Hook__redesc__flds to i64), i64 -8]
@HostTimes_Hook__desc = private global [4 x i64] [i64 0, i64 ptrtoint (%SYSTEM_MODDESC* @HostTimes__desc to i64), i64 5123, i64 ptrtoint (i64* getelementptr inbounds ([29 x i64], [29 x i64]* @HostTimes_Hook__redesc, i32 0, i32 8) to i64)]
...
@Times_Hook__redesc = external global [29 x i64]
@Times_Hook__desc = external global [4 x i64]
...
merge:                                            ; preds = %entry
  ...
  %lda5 = load i64, i64* getelementptr inbounds ([29 x i64], [29 x i64]* @Times_Hook__redesc, i32 0, i32 7)
  store i64 %lda5, i64* getelementptr inbounds ([29 x i64], [29 x i64]* @HostTimes_Hook__redesc, i32 0, i32 7)
...
if.else:                                          ; preds = %entry
  store i32 0, i32* %res
  call void @HostTimes_WS2TS(%HostTimeApi_SYSTEMTIME* %ast, %Times_SystemTime* %st, %SYSTEM_TYPEDESC* bitcast (i64* getelementptr inbounds ([23 x i64], [23 x i64]* @Times_SystemTime__recdesc, i32 0, i32 2) to %SYSTEM_TYPEDESC*))
  br label %if.end
...
if.else:                                          ; preds = %elsif
  store i32 0, i32* %res
  call void @HostTimes_WS2TS(%HostTimeApi_SYSTEMTIME* %alt, %Times_SystemTime* %lt, %SYSTEM_TYPEDESC* bitcast (i64* getelementptr inbounds ([23 x i64], [23 x i64]* @Times_SystemTime__recdesc, i32 0, i32 2) to %SYSTEM_TYPEDESC*))
  br label %if.end
...
entry:
  ...
  call void @HostTimes_TS2WS(%Times_SystemTime* %st, %SYSTEM_TYPEDESC* bitcast (i64* getelementptr inbounds ([23 x i64], [23 x i64]* @Times_SystemTime__recdesc, i32 0, i32 2) to %SYSTEM_TYPEDESC*), %HostTimeApi_SYSTEMTIME* %ast)
...
entry:
  ...
  %lft = alloca %HostTimes_FTime
  %ft = alloca %HostTimes_FTime
  call void @HostTimes_TS2WS(%Times_SystemTime* %lt, %SYSTEM_TYPEDESC* bitcast (i64* getelementptr inbounds ([23 x i64], [23 x i64]* @Times_SystemTime__recdesc, i32 0, i32 2) to %SYSTEM_TYPEDESC*), %HostTimeApi_SYSTEMTIME* %ast)
  %PCAST3 = bitcast %HostTimes_FTime* %lft to %HostTimeApi_FILETIME*
  %SystemTimeToFileTime = call x86_stdcallcc i32 @SystemTimeToFileTime(%HostTimeApi_SYSTEMTIME* %ast, %HostTimeApi_FILETIME* %PCAST3)
  %ICMP = icmp eq i32 %SystemTimeToFileTime, 0
  br i1 %ICMP, label %if.then, label %elsif
...
entry:
  ...
  %Kernel_NewRec = call i64 @Kernel_NewRec(i64 ptrtoint (i64* getelementptr inbounds ([29 x i64], [29 x i64]* @HostTimes_Hook__redesc, i32 0, i32 8) to i64))
