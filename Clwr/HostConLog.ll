...
%SYSTEM_MODDESC = type { %SYSTEM_MODDESC*, i32, i32, [6 x i16], [6 x i16], void ()*, void ()*, i32, i32, i64, i64, i64, i64, i64, i64, i64, i64, [42 x i8]*, [1 x i64]*, [3 x %SYSTEM_MODDESC*]*, %SYSTEM_DIRECTORY*, [256 x i8] }
...
@OLog_Proc__desc = external global [4 x i64]
@OLog_FlushBuf = external global void ()*
@OLog_StringProc__desc = external global [4 x i64]
@OLog_String = external global void ([0 x i16]*, i32)*
@OLog_SStringProc__desc = external global [4 x i64]
@OLog_SString = external global void ([0 x i8]*, i32)*
@OLog_USStringProc__desc = external global [4 x i64]
@OLog_USString = external global void ([0 x i8]*)*
@OLog_Ln = external global void ()*
@OLog_CharProc__desc = external global [4 x i64]
@OLog_IntProc__desc = external global [4 x i64]
@OLog_RealProc__desc = external global [4 x i64]
@OLog_BoolProc__desc = external global [4 x i64]
@OLog_SetProc__desc = external global [4 x i64]
@OLog_IntFormProc__desc = external global [4 x i64]
@OLog_RealFormProc__desc = external global [4 x i64]
@OLog_AdrProc__desc = external global [4 x i64]
